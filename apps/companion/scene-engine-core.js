...
const ACTOR_STATE_KEYS = new Set(["pugilistStance", "martialPerfection", "cocoonAwake", "growth", "gluttonConsumed", "evasion", "armor", "imposingPresence", "enemyAim", "rangerHeadshotTargetId", "berserkerLastStand", "berserkerReactionTurnSerial", "executionerBifurcate", "revenantHollowedEyes", "healerGuardianId", "enemyCrowdMovement", "privateerGearChange", "roninSheathed", "grimTransformed", "grimUsed", "warringTransformed", "warringUsed", "lastCreationSpellMarks", "modifiedOverclockTurns", "icicleSpellsRemaining", "styleCarryRemaining", "timeStopUsed", "empathSupport", "masterArmament", "wispCreationUsed"]);
