...
const geometryRuntime = context.window.DAWN_LIONWING_GEOMETRY_RUNTIME;
assert.ok(engine && plans && entities && auraTransitions && geometryRuntime, "the LionWing family APIs are installed");
...
const browserGeometryRuntime = browserMarkup.indexOf('src="lionwing-geometry-runtime.js');
...
assert.ok(browserGeometryRuntime >= 0 && browserGeometryRuntime < browserEngine, "the browser installs typed spatial plans before the LionWing engine");
