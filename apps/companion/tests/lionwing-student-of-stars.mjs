...
assert.equal(techniqueEngine.techniqueCoverage(context.window.DAWN_LIONWING_DATA, { "ruiner.student-of-stars": 3 }).find(entry => entry.id === "ruiner.student-of-stars.3")?.automation, "manual", "Moment Of Truth remains manual until Duel publishes a trusted Focus-at-entry seam");
