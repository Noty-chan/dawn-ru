...
assert.equal(Engine.masterAtArmsStatus(bladeScene, "hero", { modeId: "blade", targetIds: [], requireDestination: false }).available, false, "Blade requires targets before its movement destination so the UI cannot loop between phases");
