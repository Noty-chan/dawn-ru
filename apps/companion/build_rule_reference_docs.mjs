...
const AUDIT_FINDINGS = new Map([
  ...
  ["ruiner.bombardier.1", "Заявление full понижено до partial: area/reaction/damage pipeline существует, но preview принимает готовые `roll.successes` и не валидирует обязательное Завершение Духом."],
  ["ruiner.bombardier.2", "Заявление full понижено до partial: 3×3, range 5 и Focus≥2 проверяются, но атрибут и результаты Spirit Finisher не авторитетны."],
  ["ruiner.bombardier.3", "Заявление full понижено до partial: 5×5, range 6 и Focus≥4 проверяются, но атрибут и результаты Spirit Finisher не авторитетны; полного surface evidence нет."],
