...
const AUDIT_FINDINGS = new Map([
  ...
  ["ruiner.cryomancer.2", "Заявление decision понижено до partial: Breathe prompt тратит любой текущий 1 Focus и не доказывает, что это Фокус, полученный именно текущей Передышкой; при alternate-resource возможна ложная активация."],
  ["ruiner.feral-arcana.2", "Заявление decision понижено до partial: Ярость, ограничения ОД, Прыжки и обязательное Заклинание реализованы, но startRage принимается любым Взаимодействием без проверки канонической комбинации Зарядка → Взаимодействие."],
  ["ruiner.grim-ascendant.1", "Заявление decision понижено до partial: форма снимается при damage.apply, обнулившем Фокус, но не при resource.spend до 0; кроме того, обязательный push 3 зарегистрирован как optional displacement."],
  ["ruiner.grim-ascendant.2", "Заявление decision понижено до partial: половинный урон и Регенерация существуют, но drainLife проверяет любое Завершение и не требует каноническое Завершение Духом."],
