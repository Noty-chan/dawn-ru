...
| --- | ---: | ---: | ---: | --- |
| Уровни Техник | 321 | 79 (24.6%) | 0 | 33 частичных; 209 ручных |
...
| Оплот | 51 | 3 | 3 | 3 | 42 |
| Альтруист | 51 | 2 | 11 | 2 | 36 |
| Подрывник | 54 | 4 | 6 | 12 | 32 |
| Разрушитель | 54 | 6 | 14 | 6 | 28 |
...
| `scene-lifecycle` · Начало, конец и сброс Сцены | 26 | Один общий контракт сможет снять этот блокер сразу у нескольких адаптеров; модуль пока не закреплён |
