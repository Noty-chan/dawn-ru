...
| --- | ---: | ---: | ---: | --- |
| Уровни Техник | 333 | 83 shared/inherited (24.9%) | 0 | 57 частичных; 193 ручных |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Powerhouse | 60 | 7 | 9 | 16 | 28 |
| Vagabond | 60 | 8 | 12 | 12 | 28 |
| Bulwark | 48 | 3 | 3 | 4 | 38 |
| Altruist | 57 | 2 | 11 | 2 | 42 |
| Disruptor | 54 | 4 | 6 | 12 | 32 |
| Ruiner | 54 | 3 | 15 | 11 | 25 |
...
| `duel-flow` · Дуэли и ставки | 1 | Один общий контракт сможет снять этот блокер сразу у нескольких адаптеров; модуль пока не закреплён |
