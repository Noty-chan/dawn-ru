...
| --- | ---: | ---: | ---: | --- |
| Уровни Техник | 333 | 81 shared/inherited (24.3%) | 0 | 57 частичных; 195 ручных |
...
| `duel-flow` · Дуэли и ставки | 3 | Один общий контракт сможет снять этот блокер сразу у нескольких адаптеров; модуль пока не закреплён |
