...
| --- | ---: | ---: | ---: | --- |
| Уровни Техник | 321 | 71 (22.1%) | 0 | 40 частичных; 210 ручных |
...
| `inventory` · Инвентарь и заряды | 20 | Один общий контракт сможет снять этот блокер сразу у нескольких адаптеров; модуль пока не закреплён |
