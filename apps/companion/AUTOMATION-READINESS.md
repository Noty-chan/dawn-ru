...
| --- | ---: | ---: | ---: | --- |
| Уровни Техник | 321 | 80 (24.9%) | 0 | 28 частичных; 213 ручных |
...
| --- | ---: | --- |
| `movement-lifecycle` · Жизненный цикл движения | 92 | Один общий контракт сможет снять этот блокер сразу у нескольких адаптеров; модуль пока не закреплён |
