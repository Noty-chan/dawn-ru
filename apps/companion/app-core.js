...
function blankScene(){
  return {schema:9,version:0,name:"Структурированный бой",view:"gm",round:1,turnSerial:0,tension:0,tool:"select",activeSpace:"main",activeActorId:null,spaces:[{id:"main",name:"Основное поле",width:7,height:7}],actors:[],objects:[],markers:[],topology:{cuts:[]},artworks:[],backgroundArt:null,backgroundView:{fit:"cover",position:"center",dim:28,gridOpacity:58},featuredArt:null,selectedActor:null,targetIds:[],pendingActionPlan:null,pendingAction:null,pendingPrompt:null,triggerQueue:[],sessionClocks:[],tools:{clocksMigrated:false},rollFeed:[],log:[],undo:[]};
}
