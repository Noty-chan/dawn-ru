...
function renderPlay(){
  ...
  const stressMaximum=stressMaximumFor(currentHeroActor()||S);
  $("play-counters").innerHTML=counter("hp","Здоровье",rt.hp,d.hp)+(usesWounds?counter("wounds","Раны",rt.wounds,d.guts):"")+counter("focus","Фокус",rt.focus)+counter("ap","ОД",rt.ap)+counter("influence","Влияние",rt.influence)+counter("stress","Стресс",rt.stress,stressMaximum)+counter("tension","Напряжение",rt.tension)+(hasGift("Trust Fund")?counter("funding","Финансирование",rt.funding):"");
