...
(typeof window === "object" ? window : globalThis).DAWN_SCENE_ENGINE = { VERSION, actionCost, actorIdsInCells, actorIdsInRange, availableActions, availableEnemyRules, cancelPendingAction, cunningPlanStatus, dispatch, dispatchMany, effectiveEffects: (scene, actorId) => effectiveEffectsFor(scene, actorById(scene, actorId)), effectStatus, eventParticipants, movementPath, pendingActionStatus, prepareAction, prepareEnemyRule, preparePotionUse, preparePromptPlacement, prepareSurgery, prepareTechniqueCombo, previewEvents, projectScene, reactionOptions, resourceStatus, respondReaction, respondRulePrompt, resolvePendingAction, roundEndStatus, summarizeEvents, targetStatus, techniqueComboStatus, turnStartStatus, validateEvent };
