...
(typeof window === "object" ? window : globalThis).DAWN_SCENE_ENGINE = { VERSION, actionCost, availableActions, availableEnemyRules, cancelPendingAction, cunningPlanStatus, dispatch, dispatchMany, effectiveEffects: (scene, actorId) => effectiveEffectsFor(scene, actorById(scene, actorId)), eventParticipants, movementPath, pendingActionStatus, prepareAction, prepareEnemyRule, preparePotionUse, preparePromptPlacement, prepareSurgery, prepareTechniqueCombo, previewEvents, projectScene, reactionOptions, respondReaction, respondRulePrompt, resolvePendingAction, roundEndStatus, techniqueComboStatus, turnStartStatus, validateEvent };
