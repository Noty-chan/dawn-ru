...
function lwActionsHtml(a) {
  ...
  const breacher = Number((a.knownTechniques || a.techniques || {})["powerhouse.breacher"] || 0) >= 1 && a.lionwing?.automation?.["powerhouse.breacher.1"] === true;
