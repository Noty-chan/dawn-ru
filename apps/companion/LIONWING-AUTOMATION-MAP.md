...
| Профили Engine NPC LionWing (`lionwing.npcs.engine-profiles`) | `3-profiles-data-ready` | запрет выбранных Действий с перехватом цели; обязательная клетка к концу следующего Хода; порог урона одним случаем; изменяемый Пассив; Часы Подготовки; Козырь Н0 с повторным применением и тремя случаями урона |
...
| `lionwing.npcs.engine-profiles` | Профили Engine NPC LionWing | новый фундамент LionWing | `3-profiles-data-ready` | 122 |
