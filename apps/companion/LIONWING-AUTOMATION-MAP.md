...
| Профили Engine NPC LionWing (`lionwing.npcs.engine-profiles`) | `7-profiles-data-ready` | запрет выбранных Действий с перехватом цели; обязательная клетка к концу следующего Хода; порог урона одним случаем; изменяемый Пассив; Часы Подготовки; Козырь Н0 с повторным применением и тремя случаями урона; счетчики Рока и виртуальное Напряжение; замена Культиста усиленным NPC; движение при росте Напряжения; принудительный Ход против союзника; Ищейки с целью и взрывом |
...
| `lionwing.npcs.engine-profiles` | Профили Engine NPC LionWing | новый фундамент LionWing | `7-profiles-data-ready` | 122–123 |
