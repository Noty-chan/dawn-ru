...
| Профили Support NPC LionWing (`lionwing.npcs.support-profiles`) | `4-profiles-data-ready` | цепное перемещение союзников с лимитом на цель; сменная Атака от другого NPC; превращение Местности в Приспешников; Действия союзника в Ход Координатора; динамическое копирование профиля; копии с общими начальными параметрами |
...
| `lionwing.npcs.support-profiles` | Профили Support NPC LionWing | новый фундамент LionWing | `4-profiles-data-ready` | 120 |
