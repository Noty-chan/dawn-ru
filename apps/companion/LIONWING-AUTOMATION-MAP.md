...
| `new-lionwing-foundation` | 11 | Простой патч старой автоматики недостаточен; нужен отдельный типизированный фундамент LionWing. |
...
| Профили Tank NPC LionWing (`lionwing.npcs.tank-profiles`) | `4-profiles-data-ready` | NPC из нескольких Зон Приспешников; предел числа Зон; счетчики Роста и Покорность; повтор Атаки по новым целям; следующая за хозяином уязвимая точка; повторное применение Козыря |
...
| `lionwing.npcs.tank-profiles` | Профили Tank NPC LionWing | новый фундамент LionWing | `4-profiles-data-ready` | 117 |
