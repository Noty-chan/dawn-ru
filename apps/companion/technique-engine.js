...
(function exposeDawnTechniqueEngine(global) {
  ...
  const RULES = [
    ...
    { id: "vagabond.master-at-arms.3", techniqueId: "vagabond.master-at-arms", level: 3, name: "Мастер за работой", kind: "passive", automation: "partial", coverage: "partial", sourceDigest: "f104c7652bda2a425422af31d8d91b30515463c98f78892fe25eb204ac7508d3", note: "Экипированное Вооружение сохраняется как состояние; нейтральный hook передаёт текущий Armament в будущий Talent Finisher. Сложная геометрия Завершения остаётся под подтверждением Нарратора." },
