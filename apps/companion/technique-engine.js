...
(function exposeDawnTechniqueEngine(global) {
  ...
  const RULES = [
    ...
    { id: "vagabond.untouchable.1", techniqueId: "vagabond.untouchable", level: 1, name: "Нырок", kind: "passive", automation: "partial", coverage: "partial", sourceDigest: "348244d9362ed86da47559403a2fd0f22afb93a9647db589007e8ff203c8a26a", note: "Первый Уворот за Раунд получает авторитетные +Талант Уклонения. Событие первого Уворота и обычное расходование Уклонения ведёт ядро." },
    ...
    { id: "vagabond.sniper.1", techniqueId: "vagabond.sniper", level: 1, name: "Дальний выстрел", kind: "passive", automation: "partial", coverage: "partial", sourceDigest: "a84de0a68e37fcfc0bd9e9f2b31d19f5f09d686294b82e40138d26e0ed6ba8e8", note: "Завершение Талантом получает дальность не ниже 5 через общий конвейер дальности." },
