...
(function exposeDawnTechniqueEngine(global) {
  ...
  const RULES = [
    ...
    { id: "ruiner.bombardier.1", techniqueId: "ruiner.bombardier", level: 1, name: "Взрыв!!", kind: "area", automation: "full", shape: "adjacent", areaType: "attack", duration: "instant", range: 4, note: "Завершение Духом использует авторитетный снимок пула; центр в дальности 4 поражает выбранную клетку и четыре смежные через общий attack pipeline." },
    { id: "ruiner.bombardier.2", techniqueId: "ruiner.bombardier", level: 2, name: "Взрыв!!!", kind: "area", automation: "full", shape: "square3", areaType: "attack", duration: "instant", range: 5, optionMinimum: { key: "focusSpent", value: 2, label: "потрачено Фокуса" }, note: "При фактической оплате 2+ Фокуса Завершение Духом использует перепроверяемую зону 3×3 в дальности 5." },
    { id: "ruiner.bombardier.3", techniqueId: "ruiner.bombardier", level: 3, name: "ВЗРЫВ!!!!", kind: "area", automation: "full", shape: "square5", areaType: "attack", duration: "instant", range: 6, optionMinimum: { key: "focusSpent", value: 4, label: "потрачено Фокуса" }, note: "При фактической оплате 4+ Фокуса Завершение Духом использует перепроверяемую и обрезаемую краем поля зону 5×5 в дальности 6." },
    ...
    { id: "disruptor.siren.1", techniqueId: "disruptor.siren", level: 1, name: "Ты ведь не причинишь МНЕ боль?", kind: "passive", automation: "decision", coverage: "full", sourceDigest: "8d9becba6e6f63641f5dc1a8a47e965c73f0e7112ef7ef4b781b2c6ffb632979", note: "После Изучения врага стол предлагает потратить 1 Фокус и наложить Испуган на изученную цель, повторно проверяет цель и общий лимит 3 раза за Сцену и фиксирует применение отдельным событием." },
    ...
    { id: "disruptor.inner-world.3", techniqueId: "disruptor.inner-world", level: 3, name: "Родная территория", kind: "passive", automation: "partial", note: "Бонус Атак и Дуэлей и увеличенный лимит Домена применяются автоматически; составной выбор Домена остаётся решением игрока." },
