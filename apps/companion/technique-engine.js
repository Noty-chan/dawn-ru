...
(function exposeDawnTechniqueEngine(global) {
  ...
  const RULES = [
    ...
    { id: "ruiner.spellcrafter.2", techniqueId: "ruiner.spellcrafter", level: 2, name: "Закрепление", kind: "modifier-choice", automation: "decision", note: "Новаторство отключается, стартовый Фокус увеличивается на Разум, а изученная Модификация атомарно стоит 1 Фокус за применение." },
    { id: "ruiner.spellcrafter.3", techniqueId: "ruiner.spellcrafter", level: 3, name: "Финализация", kind: "modifier-choice", automation: "decision", note: "Второй изученный вариант сохраняется; одно действие может выбрать не более двух разных изученных Модификаций и платит за обе в одной проверяемой цепочке." },
