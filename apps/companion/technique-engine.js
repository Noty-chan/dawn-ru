...
(function exposeDawnTechniqueEngine(global) {
  ...
  const RULES = [
    ...
    { id: "disruptor.inner-world.1", techniqueId: "disruptor.inner-world", level: 1, name: "Глубокий взгляд", kind: "passive", automation: "decision", note: "После Зарядки предлагает отказаться от фактически полученного Фокуса и наложить Обездвижен на врагов в соответствующей дальности." },
