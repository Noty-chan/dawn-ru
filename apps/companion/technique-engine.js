...
(function exposeDawnTechniqueEngine(global) {
  ...
  const RULES = [
    ...
    { id: "ruiner.student-of-stars.2-line", techniqueId: "ruiner.student-of-stars", level: 2, name: "Бесформенная сила · линия", kind: "area", automation: "partial", shape: "line", areaType: "attack", duration: "instant", note: "Геометрия зональной Атаки поддержана, но она ещё не связана строго с «Высвобожденной мощью»." },
    { id: "ruiner.student-of-stars.2-zone", techniqueId: "ruiner.student-of-stars", level: 2, name: "Бесформенная сила · зона 2×2", kind: "area", automation: "partial", shape: "square2", areaType: "attack", duration: "instant", note: "Геометрия зональной Атаки поддержана, но она ещё не связана строго с «Высвобожденной мощью»." },
