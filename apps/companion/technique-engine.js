...
(function exposeDawnTechniqueEngine(global) {
  ...
  const RULES = [
    { id: "powerhouse.unbroken.1", techniqueId: "powerhouse.unbroken", level: 1, name: "Встать снова", kind: "knockout-choice", automation: "decision", coverage: "partial", sourceLevelId: "powerhouse.unbroken.1", sourceDigest: "52ba0087d2a15fd28046b031145f0604f7ef83c4bbdfce709c77d39ea167bda1", note: "Окно Сопротивления из Выведения из боя тратит 1 Влияние, действует раз за Главу и блокирует получение Влияния до конца Сцены; stale/replay/ownership проверяются перед расходом." },
    { id: "powerhouse.unbroken.3", techniqueId: "powerhouse.unbroken", level: 3, name: "Феникс", kind: "knockout-continuation", automation: "decision", coverage: "partial", sourceLevelId: "powerhouse.unbroken.3", sourceDigest: "599936806cba9c44b00cf5223615e5fcef9b76ddb60b32144e0d8f03952aee08", note: "После подтверждённого Встать снова открывается одно продолжение, устанавливающее Раны в 1; digest, chapter/scene, ownership и stale/replay границы авторитетны, ручной skip остаётся доступен." },
    { id: "powerhouse.martial-artist.1", techniqueId: "powerhouse.martial-artist", level: 1, name: "Искусство восьми молотов", kind: "passive", automation: "decision", coverage: "partial", note: "После Стычки или Завершения Телом/Талантом предлагается ровно один доступный follow up по цели этого действия; четыре варианта ограничены разом за Раунд и исключают доверенные weapon-tag Техники." },
    ...
    { id: "powerhouse.braggart.2", techniqueId: "powerhouse.braggart", level: 2, name: "Докажи, чего стоишь", kind: "passive", automation: "partial", coverage: "partial", sourceDigest: "886d7077c31b4749f8cbb789b513d61ba11e78c401e49cfafd0028bd973385c4", note: "Числовой бонус Hubris после уменьшения размера часов читается из авторитетного Clock; выбор Hold Back и его lifecycle остаются решением." },
    { id: "powerhouse.flagellant.3", techniqueId: "powerhouse.flagellant", level: 3, name: "Обескровлен", kind: "passive", automation: "partial", coverage: "partial", sourceDigest: "e309e93313cdb717c1e9a2696608090f693f9b05714076a8c7043befced940c2", note: "Первый Удар текущего Хода получает числовой бонус за число активных Эффектов из авторитетного состояния; очистка отрицательных Эффектов после броска остаётся ручной." },
    ...
    { id: "powerhouse.monastic-sage.1", techniqueId: "powerhouse.monastic-sage", level: 1, name: "Разум воплощённый", kind: "passive", automation: "full", note: "Усиление даёт 2 Брони, а Ускорение — 2 расходуемых Уклонения в конце собственного Хода." },
    { id: "powerhouse.monastic-sage.2", techniqueId: "powerhouse.monastic-sage", level: 2, name: "Меж двух миров", kind: "passive", automation: "decision", coverage: "full", foundation: "clock", clockId: "powerhouse.monastic-sage.balance", size: 8, initial: 0, note: "Баланс заполняется после авторитетно записанного чередования Атаки и утилитарного Действия; в начале Хода выбор владельца может потратить сегмент на Усиление или Ускорение." },
    { id: "powerhouse.monastic-sage.3", techniqueId: "powerhouse.monastic-sage", level: 3, name: "Возвышенная невозмутимость", kind: "passive", automation: "decision", note: "После Зарядки открывается частичное решение Медитации: проверяемо получает Уклонение, очищает Баланс и при полном Балансе даёт Фокус; телепортация и бесплатное Завершение остаются ручным продолжением." },
    { id: "vagabond.modified-meister.1.foundation", techniqueId: "vagabond.modified-meister", level: 1, name: "На горячем ходу", kind: "foundation", automation: "partial", resource: "heat", resourceLabel: "Нагрев", initial: 0, replaces: ["focus"], note: "Стоимость в Фокусе повышает Нагрев, получение Фокуса снижает его; порог 6, сброс до 3 и базовый взрыв разрешаются ядром." },
    { id: "bulwark.mundane.1.foundation", techniqueId: "bulwark.mundane", level: 1, name: "Чего не хватает Духу", kind: "foundation", foundation: "alternate-resource", automation: "partial", resource: "grit", resourceLabel: "Упорство", initialFormula: "1 + ceil(body / 2)", replaces: ["focus", "ap"], note: "Общий запас оплачивает Фокус и ОД, округляет [Тело / 2] вверх, сбрасывается в начале Раунда; Передышка и Зарядка не пополняют его." },
    ...
    { id: "vagabond.knife-juggler.2", techniqueId: "vagabond.knife-juggler", level: 2, name: "Пополнение", kind: "passive", automation: "partial", note: "После Метания создаётся маркер Оружия; вход предлагает подобрать его, получить Оружие и переместиться. Незакрыто: канонический выбор свободной смежной клетки вместо клетки цели." },
    ...
    { id: "altruist.heavenly-saint.3", techniqueId: "altruist.heavenly-saint", level: 3, name: "Великое восстановление", kind: "passive", automation: "decision", coverage: "partial", sourceDigest: "5f42cdf622ce588debfafa058a85655946db0c400a1e925653fec9b6d0568e51", note: "Духовное Завершение получает дальность 5 через общий числовой конвейер; лечение, Регенерация и снятие Раны остаются решением Техники." },
    { id: "disruptor.autophage.1.foundation", techniqueId: "disruptor.autophage", level: 1, name: "Переливание", kind: "foundation", foundation: "alternate-resource", automation: "partial", resource: "health", resourceLabel: "Здоровье", initial: 0, replaces: ["focus"], note: "Замена Фокуса Здоровьем работает, но Регенерация ошибочно требует прошедшего урона вместо успешной Атаки." },
    { id: "disruptor.autophage.2", techniqueId: "disruptor.autophage", level: 2, name: "Перенапряжение", kind: "autophage-overexert", automation: "partial", note: "Эффект и цена реализованы, но адаптер принимает устаревший успешный удар из журнала вместо текущего окна Атаки." },
    { id: "disruptor.autophage.3", techniqueId: "disruptor.autophage", level: 3, name: "Рожденный изменчивой плотью", kind: "autophage-overexert", automation: "partial", double: true, note: "Двойной эффект, цели и once/Scene реализованы, но запуск не связан с текущим Завершением и наследует stale-trigger уровня II." },
    { id: "disruptor.mind-breaker.2", techniqueId: "disruptor.mind-breaker", level: 2, name: "Что вы делаете?", kind: "passive", automation: "partial", note: "Source-aware Изгнание производит Помечен/Усилен, но канонический способ наложить Изгнание уровнем I отсутствует." },
    { id: "disruptor.mind-breaker.3", techniqueId: "disruptor.mind-breaker", level: 3, name: "Кто они?", kind: "passive", automation: "partial", note: "Единственный Изгнанный сохраняет эффект в начале Хода; перемещение двух целей и принудительная Атака отсутствуют." },
    { id: "disruptor.reaper.2", techniqueId: "disruptor.reaper", level: 2, name: "Уход", kind: "passive", automation: "partial", note: "Помечен удерживается на враге в пределах 3 клеток; уровень I, создающий каноническую Метку, не автоматизирован." },
    ...
    { id: "vagabond.aerial-master.3", techniqueId: "vagabond.aerial-master", level: 3, name: "Падающий удар топором", kind: "passive", automation: "partial", coverage: "partial", note: "В авторитетной Flight Stance по явному выбору заменяет пул Атаки на Скорость; снятие Ускорен и Launch цели остаются ручным продолжением." },
    ...
    { id: "powerhouse.technician.1", techniqueId: "powerhouse.technician", level: 1, name: "Разминка", kind: "passive", automation: "partial", sourceDigest: "79946bc3df6de994901a8519030345403e62c0fac627a76aaa8bc0ee45edda83", note: "Авторитетная Зарядка создаёт одноразовое окно до конца следующего собственного Хода; завершённое Skirmish → Finisher даёт 1 ОД. События и срок ведёт общий scheduler." },
    { id: "powerhouse.technician.2", techniqueId: "powerhouse.technician", level: 2, name: "Идеальная форма", kind: "passive", automation: "partial", sourceDigest: "87d635215f2088e683f229d48bc51b0f2bc34d6a88bc1dea707fcea12e4be250", note: "После авторитетно завершённого Skirmish → Finisher выдаётся Tier/2 Брони до начала следующего собственного Хода." },
    { id: "powerhouse.technician.3", techniqueId: "powerhouse.technician", level: 3, name: "Последний удар", kind: "combo", automation: "partial", sourceDigest: "69e9007f8f65def64ef7640b8441616852def68765ad7a717f09587b1039ecfe", sequenceKeys: ["skirmish", "finish"], actionKey: "finish", apCost: 1, postPush: 3 },
    ...
    { id: "powerhouse.duelist.2", techniqueId: "powerhouse.duelist", level: 2, name: "Парирование", kind: "passive", automation: "partial", coverage: "partial", sourceDigest: "6ac5d7c737f81f4ba33f9a649d3bdfae9c2627d6420540f72f9626c53efb0827", note: "Блок получает авторитетное Напряжение дополнительной Бронёй. Незакрыто: условие смежного атакующего, Ошеломление и толчок вместо владельца." },
    { id: "powerhouse.lancer.1", techniqueId: "powerhouse.lancer", level: 1, name: "Пробить", kind: "passive", automation: "partial", coverage: "partial", sourceDigest: "8591643bda0a61a4165679413af42b8b60a40ca90dc47dc5a9d6ee1c32a5e701", note: "Стычка и Завершение Телом получают дальность не ниже 2; дальностное Преимущество Стычки ограничено 3. Остальные детали выбора цели остаются в общем действии." },
    { id: "powerhouse.lancer.2", techniqueId: "powerhouse.lancer", level: 2, name: "Фаланга", kind: "passive", automation: "partial", coverage: "partial", sourceDigest: "bbc32f09a04b64473f2a4eaacdb4686a3827af112fa7b2737d5117fcc1975c1b", note: "Стычка и Завершение Телом получают дальность не ниже 3. Поражение всех противников между владельцем и целью остаётся ручным расширением." },
    { id: "powerhouse.lancer.3", techniqueId: "powerhouse.lancer", level: 3, name: "Рука-пушка", kind: "passive", automation: "partial", coverage: "partial", sourceDigest: "cf89959221bf368de82bf3bc9e6c4e2d64fd30d5b33a5095e355a6aa93aab5c0", note: "После авторитетной последовательности Передышка → Стычка дальность Стычки не ниже 4 и дальностное Преимущество может достигать 4. Зона, трудная местность и точный выбор последовательности остаются ручными." },
    ...
    { id: "vagabond.assassin.1", techniqueId: "vagabond.assassin", level: 1, name: "Засада", kind: "passive", automation: "full", note: "Первое действие после последнего Развертывания проверяется по журналу; только Скрыться становится бесплатным и игнорирует требования." },
    { id: "vagabond.assassin.2", techniqueId: "vagabond.assassin", level: 2, name: "Ликвидация", kind: "passive", automation: "decision", note: "Сохраняемый план разрешает отменяемое смежное появление; ядро повторно проверяет источник Исчезновения, клетку, цели и авторитетный бросок с [Ступень] Преимущества и критом на 5–6." },
    ...
    { id: "vagabond.untouchable.1", techniqueId: "vagabond.untouchable", level: 1, name: "Нырок", kind: "passive", automation: "full", coverage: "full", sourceDigest: "348244d9362ed86da47559403a2fd0f22afb93a9647db589007e8ff203c8a26a", note: "Первый Уворот за Раунд получает авторитетные +Талант Уклонения; адаптер читает квитанцию Уворота и текущий Раунд, а повтор и следующий Раунд проходят через общий lifecycle." },
    { id: "vagabond.untouchable.2", techniqueId: "vagabond.untouchable", level: 2, name: "Маятник", kind: "passive", automation: "partial", coverage: "partial", sourceDigest: "abd33cfc8f9dfb48eaf90234e99044a1f3c16d2d99d527286e6dd14c52d7433e", note: "Уворот получает +1 к дальности движения. Повторное движение после снижения урона до 0 остаётся решением игрока." },
    { id: "vagabond.sniper.1", techniqueId: "vagabond.sniper", level: 1, name: "Дальний выстрел", kind: "passive", automation: "full", coverage: "full", sourceDigest: "a84de0a68e37fcfc0bd9e9f2b31d19f5f09d686294b82e40138d26e0ed6ba8e8", note: "Завершение Талантом получает дальность не ниже 5 через общий конвейер дальности; другие действия и дальность выше 5 сохраняются без изменений." },
    { id: "vagabond.sniper.2", techniqueId: "vagabond.sniper", level: 2, name: "Окопаться", kind: "passive", automation: "partial", coverage: "partial", sourceDigest: "e154b6164f886770be2bb7a63a6a86bd7be83a88967eecaeb1f801b631874767", note: "При авторитетной Обездвиженности Завершение Талантом получает ещё 5 дальности. Вход в Обездвиженность и крит на 5–6 остаются ручными." },
    { id: "vagabond.drunkard.2", techniqueId: "vagabond.drunkard", level: 2, name: "Пляска дурака", kind: "passive", automation: "partial", coverage: "partial", sourceDigest: "73477795efb4e90b3c7bf8d17ed305b312f08703a0085672f72b5e0a869dde56", note: "После собственного Хода с авторитетным Замедлен Эффектом выдаётся временное Уклонение на начало следующего Хода; размер читает Ранг/2 и число отрицательных Эффектов. Обязательное движение первого уровня остаётся ручным." },
    { id: "ruiner.flame-heart.3", techniqueId: "ruiner.flame-heart", level: 3, name: "Пепел к пеплу", kind: "passive", automation: "partial", coverage: "partial", sourceDigest: "4896f18d23e7ba4de201859ecfb76d46c7049c32e532747831b973b2d75c6d29", note: "Заклинания получают +1 Преимущество, а Духовное Завершение — дальность 5 через общий числовой конвейер. Снятие Порчи и Х-образная область остаются ручными." },
    ...
    { id: "vagabond.master-at-arms.1", techniqueId: "vagabond.master-at-arms", level: 1, name: "Многогранность", kind: "armament", automation: "full", coverage: "full", sourceDigest: "d35f468065e84fbb0c86bc60015632bdbcfe9b0ced2ed2cfa370453f64a72371", note: "Вооружение выбирается вместе со Стычкой; ядро проверяет дистанцию, число целей и повторное экипирование, хранит взаимоисключающий режим, затем ведёт перемещение, Эффекты и толчок. Каждое Вооружение ограничено одним разом за Ход." },
    { id: "vagabond.master-at-arms.2", techniqueId: "vagabond.master-at-arms", level: 2, name: "Как вода", kind: "passive", automation: "full", coverage: "full", sourceDigest: "743ae31f60f1a826d3346b6e07c7cff94983860c399cdc9484302e120fd726c4", note: "Второе экипирование за Ход автоматически даёт 1 ОД и Ускорен." },
    { id: "vagabond.master-at-arms.3", techniqueId: "vagabond.master-at-arms", level: 3, name: "Мастер за работой", kind: "passive", automation: "full", coverage: "full", sourceDigest: "f104c7652bda2a425422af31d8d91b30515463c98f78892fe25eb204ac7508d3", note: "Только Завершение Талантом читает текущее авторитетное Вооружение: Клинок проверяет путь до 2 клеток, Древко строит Линию длиной 2, а Цепь строит 1×1 и расширяет её по проверенным Критам." },
    { id: "altruist.surgeon.1", techniqueId: "altruist.surgeon", level: 1, name: "Не навреди", kind: "surgery", automation: "partial", note: "Смежный союзник, стоимость и округлённое вверх лечение работают, но ядро принимает готовые successes и не доказывает обязательный бросок Разума." },
    { id: "altruist.alchemist.1", techniqueId: "altruist.alchemist", level: 1, name: "Быстрая смесь", kind: "inventory", automation: "decision", note: "Передышка опционально создаёт один из канонических типов; Взаимодействие проверяет запас и дальность, а Чистая вода выбирает любое подмножество Эффектов до оплаты и расхода Зелья." },
    { id: "altruist.alchemist.2", techniqueId: "altruist.alchemist", level: 2, name: "Мощная смесь", kind: "passive", automation: "decision", note: "Союзник автоматически получает ceil(Разум/2) Фокуса; для врага после фактического использования Зелья открывается перепроверяемый выбор нанести Разум урона или отказаться." },
    { id: "altruist.chronomancer.2", techniqueId: "altruist.chronomancer", level: 2, name: "Замедление", kind: "passive", automation: "decision", note: "Заклинания получают 1 Преимущество; удаление Эффекта открывает перепроверяемое окно повторного применения за 1 Фокус." },
    ...
    { id: "ruiner.spellcrafter.1", techniqueId: "ruiner.spellcrafter", level: 1, name: "Эксперимент", kind: "modifier-choice", automation: "decision", note: "Одна изученная Модификация сохраняется в листе, сцене и импорте; каждое применение к Заклинанию или Завершению атомарно тратит 1 Новаторство." },
    { id: "ruiner.spellcrafter.2", techniqueId: "ruiner.spellcrafter", level: 2, name: "Закрепление", kind: "modifier-choice", automation: "decision", note: "Получается вторая изученная Модификация; Новаторство отключается, стартовый Фокус увеличивается на Разум, а каждая выбранная Модификация атомарно стоит 1 Фокус за применение." },
    { id: "ruiner.spellcrafter.3", techniqueId: "ruiner.spellcrafter", level: 3, name: "Финализация", kind: "modifier-choice", automation: "decision", note: "Получается третья изученная Модификация; одно действие может выбрать не более двух разных изученных Модификаций и платит за обе в одной проверяемой цепочке." },
    { id: "ruiner.bombardier.1", techniqueId: "ruiner.bombardier", level: 1, name: "Взрыв!!", kind: "area", automation: "partial", shape: "adjacent", areaType: "attack", duration: "instant", range: 4, note: "Частично автоматизировано: Завершение Духом требует вражескую цель в центре в дальности 4 и поражает её и все доступные смежные клетки; полный surface-сверка ещё требует проверки." },
    { id: "ruiner.bombardier.2", techniqueId: "ruiner.bombardier", level: 2, name: "Взрыв!!!", kind: "area", automation: "partial", shape: "square3", areaType: "attack", duration: "instant", range: 5, optionMinimum: { key: "focusSpent", value: 2, label: "потрачено Фокуса" }, note: "Частично автоматизировано: при фактической оплате 2+ Фокуса Завершение Духом перепроверяет зону 3×3 в дальности 5 и получает по 1 Преимуществу за пустую клетку с пределом [Ступень+2]; полный surface-контракт остаётся ручным." },
    { id: "ruiner.bombardier.3", techniqueId: "ruiner.bombardier", level: 3, name: "ВЗРЫВ!!!!", kind: "area", automation: "partial", shape: "square5", areaType: "attack", duration: "instant", range: 6, optionMinimum: { key: "focusSpent", value: 4, label: "потрачено Фокуса" }, note: "Частично автоматизировано: при фактической оплате 4+ Фокуса Завершение Духом перепроверяет зону 5×5 в дальности 6; полный surface-контракт остаётся ручным." },
    { id: "ruiner.rapid-fire-sorcery.2", techniqueId: "ruiner.rapid-fire-sorcery", level: 2, name: "Выжженная земля", kind: "area", automation: "partial", shape: "cell", areaType: "difficult", duration: "scene", note: "Размещение трудной местности поддержано; создание только после урона пустой клетке и входной урон ещё требуют общего конвейера." },
    { id: "ruiner.ritualist.1", techniqueId: "ruiner.ritualist", level: 1, name: "Лей-линии", kind: "marker", automation: "partial", markerKind: "ritual", duration: "scene", color: "#6fc9d8", note: "Круг и бонус работают, но отдельная кнопка не требует Зарядки и не отказывается от полученного ею Фокуса." },
    { id: "ruiner.student-of-stars.1", techniqueId: "ruiner.student-of-stars", level: 1, name: "Высвобожденная мощь", kind: "action-modifier", automation: "partial", actionKey: "finish", sourceDigest: "64d7fc6b8ff19f2f7ab1b9b12c8021872835baf6374bb729837f7d2f2a27fa60", note: "После подтверждённой Зарядки Завершение стоит 1 ОД; предел дополнительного Фокуса вычисляется Engine как 3×текущее Напряжение." },
    { id: "ruiner.student-of-stars.2-line", techniqueId: "ruiner.student-of-stars", level: 2, name: "Бесформенная сила · линия", kind: "area", automation: "partial", shape: "line", areaType: "attack", duration: "instant", sourceDigest: "6fd4f1cf8b3ee7fbe492fd7a439792e61c568bd4c28d0b6efe80071d99482d7e", note: "После Высвобожденной мощи Engine перепроверяет бесконечную линию, центр в соседней клетке и цели по общей геометрии." },
    { id: "ruiner.student-of-stars.2-zone", techniqueId: "ruiner.student-of-stars", level: 2, name: "Бесформенная сила · зона 2×2", kind: "area", automation: "partial", shape: "square2", areaType: "attack", duration: "instant", sourceDigest: "6fd4f1cf8b3ee7fbe492fd7a439792e61c568bd4c28d0b6efe80071d99482d7e", note: "После Высвобожденной мощи Engine перепроверяет зону 2×2, центр в соседней клетке и цели по общей геометрии." },
    { id: "ruiner.student-of-stars.3", techniqueId: "ruiner.student-of-stars", level: 3, name: "Момент истины", kind: "duel-entry", automation: "decision", sourceDigest: "806d52c0296048d69a25b379d8dcdfa5690dbee0cef391ea6894485016393f6e", note: "Перед входом в Дуэль стол показывает фактический Фокус; при 6+ владелец может потратить весь снимок и получить ceil(Фокус/2) Преимущества только в этой Дуэли. Выбор, отмена и квитанция переживают reload/replay." },
    { id: "ruiner.ego-arm.2", techniqueId: "ruiner.ego-arm", level: 2, name: "Покажи свои цели", kind: "marker", automation: "manual", markerKind: "damocles", duration: "scene", color: "#d04f64", note: "Нужна модель носителя/трансформации: в каноне маркеры ставятся в конце Хода на клетках всех врагов, атакованных носителем; текущий произвольный выбор клетки нельзя показывать как автоматизацию." },
    { id: "ruiner.sellsword-s-call.1", techniqueId: "ruiner.sellsword-s-call", level: 1, name: "Реприза воина", kind: "marker", automation: "partial", markerKind: "summon", duration: "scene", color: "#6fc9d8", note: "Точка призыва ставится только в пустую клетку за 1 Фокус, с выбором типа и лимитом [Ступень/2]. Незакрыто: полноценный Призыв-участник с 1 Здоровьем, профильной Атакой, половиной урона и Ходом." },
    ...
    { id: "disruptor.wave-rider.1", techniqueId: "disruptor.wave-rider", level: 1, name: "Мягкие волны", kind: "marker", automation: "partial", markerKind: "ritual", duration: "scene", color: "#3fa9d4", note: "Печати сохраняются с лимитом 4+Ступень, а владелец разрешает их срабатывание; Быстрота и бесплатность первого подходящего Заклинания ещё не подключены." },
    ...
    { id: "disruptor.hunter.3", techniqueId: "disruptor.hunter", level: 3, name: "Яма-ловушка", kind: "area", automation: "partial", shape: "square2", areaType: "terrain", duration: "scene", note: "Геометрия ямы поддержана; объединение четырёх ловушек и Завершение Разумом ещё не автоматизированы." },
    { id: "disruptor.siren.1", techniqueId: "disruptor.siren", level: 1, name: "Ты ведь не причинишь МНЕ боль?", kind: "passive", automation: "decision", coverage: "partial", sourceDigest: "8d9becba6e6f63641f5dc1a8a47e965c73f0e7112ef7ef4b781b2c6ffb632979", note: "В начале каждой Сцены даёт 3 Фокуса без лимита применений; после авторитетного Изучения врага предлагает потратить 1 Фокус и наложить Испуган на изученную цель. Текст уровня не содержит ограничения «3 раза за Сцену»; UI/network surface-сверка остаётся ручной." },
    { id: "disruptor.gale-strider.1", techniqueId: "disruptor.gale-strider", level: 1, name: "Растущие ветра", kind: "area", automation: "partial", shape: "square3", areaType: "danger", duration: "scene", note: "Тайфун заменяет прежний и его групповое смещение разрешается владельцем; размещение после Заклинания или Прыжка пока запускается отдельно." },
    ...
    { id: "disruptor.chemist.2", techniqueId: "disruptor.chemist", level: 2, name: "Экспериментальная смесь", kind: "passive", automation: "partial", note: "Незакрыто: опциональный запрос Нарратору о скрытом Здоровье; текущий автоматический KO не может заменять это решение." },
    { id: "disruptor.chemist.3", techniqueId: "disruptor.chemist", level: 3, name: "Осаждение", kind: "passive", automation: "full" },
    { id: "disruptor.inner-world.1", techniqueId: "disruptor.inner-world", level: 1, name: "Глубокий взгляд", kind: "passive", automation: "partial", note: "Основная ветка работает, но trigger может подобрать старое получение Фокуса от прежней Зарядки вместо текущего события." },
    { id: "disruptor.inner-world.2", techniqueId: "disruptor.inner-world", level: 2, name: "Домен контроля", kind: "space", automation: "decision", spaceName: "Внутренний мир", width: 3, height: 3, note: "После наложения Эффекта предлагает перенос выбранных участников в отдельное пространство 3×3 с возвратом на край поля при Ране или нокауте." },
    { id: "disruptor.inner-world.3", techniqueId: "disruptor.inner-world", level: 3, name: "Родная территория", kind: "passive", automation: "partial", sourceDigest: "fb44b773e2eb1b59c5691f7f5f6b9a2b624f2b9d3cdcffe70ee98cd46a597dff", note: "Бонус Тир Преимущества в Дуэле сохраняется в entry/resolve snapshot только внутри собственного Внутреннего мира; составной выбор Домена остаётся решением игрока." },
    { id: "bulwark.giant-frame.1", techniqueId: "bulwark.giant-frame", level: 1, name: "Огромные руки", kind: "area", automation: "partial", shape: "square2", areaType: "attack", duration: "instant", adjacency: true, optionMinimum: { key: "focusSpent", value: 1, label: "дополнительно потрачено Фокуса" }, note: "Зона, оплата и общий конвейер Атаки поддержаны; замена цели конкретного Завершения Телом ещё не связана атомарно." },
    { id: "powerhouse.warring-ascendant.3", techniqueId: "powerhouse.warring-ascendant", level: 3, name: "Святой меч, Дюрандаль", kind: "area", automation: "partial", shape: "line", areaType: "attack", duration: "instant", adjacency: true, note: "Трансформация и Линия проверяются; потеря трансформации и дополнительный урон за каждую цель ещё не разрешаются полностью." },
    { id: "powerhouse.breacher.1", techniqueId: "powerhouse.breacher", level: 1, name: "Картечь", kind: "passive", automation: "full", note: "Стычка получает дальность 4; выбранная одиночная цель в пределах 2 после успешной Атаки проходит обычные Реакции и затем отталкивается на 1 через общий post-hit displacement." },
    { id: "powerhouse.breacher.2", techniqueId: "powerhouse.breacher", level: 2, name: "Из обоих стволов", kind: "passive", automation: "full", note: "До Стычки при отсутствии Ослаблен можно включить режим: [Тело/2] Преимущества, удвоение толчка и Ослаблен после разрешения." },
    { id: "powerhouse.breacher.3", techniqueId: "powerhouse.breacher", level: 3, name: "Уничтожение", kind: "passive", automation: "partial", note: "Завершение Телом получает дальность 3; режим Из обоих стволов может выбрать проверенную зону 2×2, смежную с владельцем, по всем персонажам зоны." },
  ...
  const SOURCE_PROVENANCE = Object.freeze({
    ...
    "powerhouse.braggart.1": ["powerhouse.braggart.1", "27b8843e65beccd8722b61b6ecba36261f77a23c31119b7fae82f4785937ab77"],
    ...
    "powerhouse.flagellant.3": ["powerhouse.flagellant.3", "e309e93313cdb717c1e9a2696608090f693f9b05714076a8c7043befced940c2"],
    ...
    "bulwark.iron-bodied.3": ["bulwark.iron-bodied.3", "7726f5c94cfdfba228b739db1cad6221687af83bf183a7c16bed34afd5a6526f"],
    ...
    "powerhouse.technician.1": ["powerhouse.technician.1", "79946bc3df6de994901a8519030345403e62c0fac627a76aaa8bc0ee45edda83"],
    "powerhouse.technician.2": ["powerhouse.technician.2", "87d635215f2088e683f229d48bc51b0f2bc34d6a88bc1dea707fcea12e4be250"],
    ...
    "powerhouse.lancer.1": ["powerhouse.lancer.1", "8591643bda0a61a4165679413af42b8b60a40ca90dc47dc5a9d6ee1c32a5e701"],
    "powerhouse.lancer.2": ["powerhouse.lancer.2", "bbc32f09a04b64473f2a4eaacdb4686a3827af112fa7b2737d5117fcc1975c1b"],
    "powerhouse.lancer.3": ["powerhouse.lancer.3", "cf89959221bf368de82bf3bc9e6c4e2d64fd30d5b33a5095e355a6aa93aab5c0"],
    ...
    "vagabond.aerial-master.3": ["vagabond.aerial-master.3", "af9100fcba37294038c9e66fb6fd2aed9fb592bd0468468ebcce546b087bf3ac"],
    "vagabond.skirmisher.3": ["vagabond.skirmisher.3", "4933347df61d45014a553af1c97f078e20ee677081e433464ba9c96726513c61"],
    ...
    "vagabond.sniper.1": ["vagabond.sniper.1", "a84de0a68e37fcfc0bd9e9f2b31d19f5f09d686294b82e40138d26e0ed6ba8e8"],
    "vagabond.sniper.2": ["vagabond.sniper.2", "e154b6164f886770be2bb7a63a6a86bd7be83a88967eecaeb1f801b631874767"],
    "vagabond.drunkard.2": ["vagabond.drunkard.2", "73477795efb4e90b3c7bf8d17ed305b312f08703a0085672f72b5e0a869dde56"],
    "ruiner.flame-heart.3": ["ruiner.flame-heart.3", "4896f18d23e7ba4de201859ecfb76d46c7049c32e532747831b973b2d75c6d29"],
    ...
    "ruiner.student-of-stars.3": ["ruiner.student-of-stars.3", "806d52c0296048d69a25b379d8dcdfa5690dbee0cef391ea6894485016393f6e"],
    "disruptor.inner-world.3": ["disruptor.inner-world.3", "fb44b773e2eb1b59c5691f7f5f6b9a2b624f2b9d3cdcffe70ee98cd46a597dff"],
    "powerhouse.breacher.1": ["powerhouse.breacher.1", "9e9680211a203830a82230d86136cc85108032eaea3655fc9e991129d2826af5"],
    "powerhouse.breacher.2": ["powerhouse.breacher.2", "d632e668fdf4e39e44c32cc7c36973f9272fcb04d36a611ebfe7c55be96c565c"],
    "powerhouse.breacher.3": ["powerhouse.breacher.3", "ddb18671a7bf29177c52af4b26a5bc35b6408dd125d75007abd25e547f2ac6b3"],
    ...
    "powerhouse.monastic-sage.1": ["powerhouse.monastic-sage.1", "f1ff824c2299d7184c07c4bf6a212d3a2f8c40a914d18948ed0c1987059480cc"],
    "powerhouse.monastic-sage.2": ["powerhouse.monastic-sage.2", "68c84fc146d316b7508a983d89e6438f07785d78ff8bb885ac25dade66f40c60"],
    "powerhouse.monastic-sage.3": ["powerhouse.monastic-sage.3", "b12c0e7f1d63dd1217d15f64aa7f2fcb7bbfa649761b476eb5e0840bc36ba994"],
  });
  ...
  function techniqueCoverage(data, techniques = null) {
    ...
    return archetypes.flatMap(archetype => (archetype.techniques || []).flatMap(technique => {
      ...
      return (technique.levels || []).filter(level => Number(level.n) <= knownLevel).map(level => {
        ...
        // A canonical mechanics annotation is a map/review aid, not executable automation.
        // Without a rule registered in this engine, the level must remain manual.
        const automation = rules.length ? (statuses.includes("manual") ? "manual" : statuses.every(status => status === "full") ? "full" : statuses.includes("decision") ? "decision" : "partial") : "manual";
  ...
  function manualPreview(scene, request = {}) {
    ...
    return {
      ...
      rule: { id: entry?.id || "manual", techniqueId: entry?.techniqueId, level: entry?.level, name, automation: "manual", canonicalText: entry?.canonicalText || null, source: clone(entry?.canonicalSource || entry?.source || null) },
      errors,
      ...
      request: { targetIds: clone(request.targetIds || []), note: String(request.note || "").slice(0,500), entryId: entry?.id || null, source: clone(entry?.canonicalSource || entry?.source || null), canonicalText: entry?.canonicalText || null },
  ...
  function preview(scene, request = {}) {
    ...
    if (rule.kind === "area" && !errors.length) {
      ...
      if (rule.id === "disruptor.gale-strider.1") {
        (scene.objects || []).filter(object => object.type === "danger" && object.ownerActorId === actor.id && /Тайфун|gale-strider/.test(`${object.label || ""} ${object.ruleId || object.source || ""}`)).forEach(object => commands.push({ type: "remove_area", id: object.id, label: object.label }));
      }
    ...
    if (rule.kind === "marker" && !errors.length) {
      ...
      if (rule.id === "ruiner.ritualist.1") (scene.markers || []).filter(item => String(item.ruleId || item.source || "").startsWith(rule.id) && item.ownerActorId === actor.id && item.duration === "scene").forEach(item => commands.push({ type: "remove_marker", markerId: item.id, label: item.label }));
