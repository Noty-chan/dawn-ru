...
(function exposeDawnTechniqueEngine(global) {
  ...
  const RULES = [
    ...
    { id: "ruiner.ritualist.1", techniqueId: "ruiner.ritualist", level: 1, name: "Лей-линии", kind: "marker", automation: "decision", markerKind: "ritual", duration: "scene", color: "#6fc9d8", note: "Заклинательный круг ставится только в текущую клетку героя, заменяет его прежний круг и повышает предел Фокуса Завершения Духом; решение после Зарядки остаётся явным." },
