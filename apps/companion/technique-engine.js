...
(function exposeDawnTechniqueEngine(global) {
  ...
  const RULES = [
    ...
    { id: "ruiner.cryomancer.2.foundation", techniqueId: "ruiner.cryomancer", level: 2, name: "Ледяной нимб", kind: "foundation", foundation: "clock", automation: "partial", clockId: "ruiner.cryomancer.icicle", size: 4, initial: 0, note: "Часы и серия работают, но отказ тратит любой текущий Фокус и не связан с Фокусом именно этой Передышки." },
    { id: "ruiner.feral-arcana.2.foundation", techniqueId: "ruiner.feral-arcana", level: 2, name: "Сорваться с цепи", kind: "foundation", foundation: "clock", automation: "partial", clockId: "ruiner.feral-arcana.rage", size: 6, initial: 0, note: "Часы, ограничения ОД, Быстрые Прыжки и обязательное Заклинание реализованы, но Ярость можно начать обычным Взаимодействием без канонической предшествующей Зарядки." },
    ...
    { id: "vagabond.assassin.1", techniqueId: "vagabond.assassin", level: 1, name: "Засада", kind: "passive", automation: "partial", note: "Первое Скрыться в пустом журнале Сцены бесплатно и игнорирует требования; нет привязки к последнему Развертыванию, поэтому повторное/позднее Развертывание не покрыто." },
    { id: "vagabond.assassin.2", techniqueId: "vagabond.assassin", level: 2, name: "Ликвидация", kind: "passive", automation: "partial", note: "Сохраняемый план разрешает отменяемый выбор клетки появления, включая смежную; ядро не добавляет и не валидирует [Ступень] Преимущества и критические успехи на 5–6." },
    ...
    { id: "altruist.alchemist.1", techniqueId: "altruist.alchemist", level: 1, name: "Быстрая смесь", kind: "inventory", automation: "partial", note: "Создание, запас, дальность и пять одноэффектных Зелий работают; Чистая вода удаляет все Эффекты без канонического выбора подмножества." },
    { id: "altruist.alchemist.2", techniqueId: "altruist.alchemist", level: 2, name: "Мощная смесь", kind: "passive", automation: "partial", note: "Фокус союзнику работает; для врага нужен отсутствующий канонический выбор, наносить ли урон." },
    ...
    { id: "ruiner.spellcrafter.1", techniqueId: "ruiner.spellcrafter", level: 1, name: "Эксперимент", kind: "modifier-choice", automation: "partial", note: "Эффекты модификаций работают, но UI позволяет выбирать любую из четырёх вместо одной, зафиксированной при получении уровня." },
    { id: "ruiner.spellcrafter.2", techniqueId: "ruiner.spellcrafter", level: 2, name: "Закрепление", kind: "modifier-choice", automation: "partial", note: "Оплата Фокусом и стартовый бонус есть, но отсутствует постоянный набор изученных модификаций уровня I." },
    { id: "ruiner.spellcrafter.3", techniqueId: "ruiner.spellcrafter", level: 3, name: "Финализация", kind: "modifier-choice", automation: "partial", note: "Две разные модификации оплачиваются, но могут быть выбраны из полного списка независимо от изученного набора." },
    { id: "ruiner.bombardier.1", techniqueId: "ruiner.bombardier", level: 1, name: "Взрыв!!", kind: "area", automation: "partial", shape: "adjacent", areaType: "attack", duration: "instant", range: 4, note: "Геометрия и attack pipeline готовы, но preview не доказывает обязательный бросок Завершения Духом." },
    { id: "ruiner.bombardier.2", techniqueId: "ruiner.bombardier", level: 2, name: "Взрыв!!!", kind: "area", automation: "partial", shape: "square3", areaType: "attack", duration: "instant", range: 5, optionMinimum: { key: "focusSpent", value: 2, label: "потрачено Фокуса" }, note: "Зона и минимум Фокуса готовы, но атрибут и результаты Завершения Духом доверены запросу." },
    { id: "ruiner.bombardier.3", techniqueId: "ruiner.bombardier", level: 3, name: "ВЗРЫВ!!!!", kind: "area", automation: "partial", shape: "square5", areaType: "attack", duration: "instant", range: 6, optionMinimum: { key: "focusSpent", value: 4, label: "потрачено Фокуса" }, note: "Зона, цели, трата Фокуса и Реакции работают, но обязательный Spirit Finisher roll не валидируется авторитетно." },
    ...
    { id: "ruiner.grim-ascendant.1", techniqueId: "ruiner.grim-ascendant", level: 1, name: "Непостоянная мощь", kind: "passive", automation: "partial", note: "Prompt и перенаправление урона/лечения работают, но форма не прекращается при расходе Фокуса до 0, а обязательные толчки ошибочно опциональны." },
    { id: "ruiner.grim-ascendant.2", techniqueId: "ruiner.grim-ascendant", level: 2, name: "Вытянуть жизнь", kind: "state-toggle", stateKey: "drainLife", automation: "partial", note: "Половинный урон и Регенерация работают, но ядро не требует Завершение Духом и принимает любой тип Завершения." },
    ...
    { id: "altruist.will-o-wisp.1", techniqueId: "altruist.will-o-wisp", level: 1, name: "Пламя духовного плетения", kind: "passive", automation: "partial", note: "Первая Зарядка, выбранная аура и ручное движение Пламени работают; обязательный толчок маркера при атаке его клетки отсутствует." },
    { id: "altruist.will-o-wisp.2", techniqueId: "altruist.will-o-wisp", level: 2, name: "Дружелюбные духи", kind: "passive", automation: "partial", note: "Выход из Пламени вызывает выбор, но enemy movement уже разрешён целиком и затем откатывается: путь не обрывается до downstream enter-триггеров." },
