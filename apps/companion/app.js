...
if(!Scene.actors.length&&Scene.rulesEdition!==contentPreferences.edition){Scene.rulesEdition=contentPreferences.edition;Scene.undo=[];Scene.redo=[];Scene.turnUndo=[];persist();}
