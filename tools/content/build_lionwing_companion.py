...
def parse_reference_sections() -> list[dict]:
    ...
    cards = [
        ("system-cliff-notes", "Mechanical Cliff Notes", "System, Introduction",
         "DAWN is a setting-agnostic, grid-based combat game using pools of d6s: 4+ is a Hit and each 6 is a Critical Hit that adds another die. Structured combat and unstructured play use mostly separate character features. Influence and Antagonism connect both modes. Characters build a custom Ability for unstructured play and combine individual Techniques rather than choosing a restrictive class. Ordinary equipment and inventory are handled through the fiction, not item accounting.", 6),
        ("system-assumptions", "Inspirations And Assumptions", "System, Introduction, Safety",
         "DAWN draws on battle shōnen, tactical games, and narrative TTRPGs. It assumes the group enjoys fictional combat, uses a world where defeat need not mean death, and communicates respectfully while sharing dramatic spotlight. Groups that do not share these assumptions should discuss changes before play and choose another game if they cannot reconcile them.", 7),
        ("system-limits", "What DAWN Does Not Do", "System, Introduction, Scope",
         "DAWN is not designed to evoke sustained horror, bypass major conflicts instead of confronting them, or model a fully fluid supernatural system where everyone freely learns the same broad powers. Its genre focus also does not attempt to reproduce every shōnen convention. These are design boundaries, not prohibitions, and groups may need substantial adaptation to work outside them.", 8),
        ("world-creation", "World Creation Activity", "Creation, World, Group Activity",
         "Choose a rotating leader. They propose an answer; the group marks it Might Use or Won't Use, and any firm objection makes it Won't Use. Rotate left, repeating the prompt after a rejection or moving on after a possible acceptance. Decide: real-world period; source and publicity of the supernatural; public knowledge or concern; functional and aesthetic inspirations for empowered characters; their short name; how they help ordinary people; a natural enemy; the world's short name; and its factions and reasons to support or oppose them. A solo creator may instead try 3–4 ideas per prompt.", 20),
        ("outlook-story-rebellion", "Primary Outlook Question: Your Rebellion", "Creation, Story, Outlook, Rebel",
         "Show them what they did to you; make them pay. The world has rules, organizations, and traditions that preserve its status quo, but your existence breaks those rules. Why? Also ask whether and how the Change affected your rule-breaking nature.", 49),
        ("outlook-story-oath", "Primary Outlook Question: Your Oath", "Creation, Story, Outlook, Loyal",
         "Power requires discipline, and discipline requires focus. Something that happened to you made you take an Oath toward someone or something. What is it? Also ask to whom or what you made this Oath, and why.", 49),
        ("outlook-story-community", "Primary Outlook Question: Your Community", "Creation, Story, Outlook, Light",
         "Not family and not coworkers, but something more special. After moving away from your family, you became deeply integrated into a second group. Who are they? Also ask whether this community is connected to the other player characters.", 50),
        ("outlook-story-disappearance", "Primary Outlook Question: Your Disappearance", "Creation, Story, Outlook, Wolf",
         "Something inside you is dead, and you have to move on. You once belonged to a rich community whose peers respected you and had your respect, but you can never go back. Why? Also ask whether that community still exists and how it fares without you.", 50),
        ("outlook-story-past", "Primary Outlook Question: Your Past", "Creation, Story, Outlook, Mentor",
         "You used to be like them; how the years fly. Choose the Your Story question of any other Outlook and answer it in addition to this one. Also ask what has happened to you since then and how often you still think about those days.", 51),
        ("outlook-story-future", "Primary Outlook Question: Your Future", "Creation, Story, Outlook, Apprentice",
         "Everyone else is doing so well; begin the climb. Once, and only once before the adventure begins, you meet a legendary person whom you have heard about and idolized all your life. Who are they? Also ask how you resemble them and how you differ.", 51),
        ("outlook-story-fall", "Primary Outlook Question: Your Fall", "Creation, Story, Outlook, Accursed",
         "Everyone knows a fall can happen but never expects their own. Something supernatural implanted itself in you. What is it? Also ask how much you know about what happened and whether it relates to the Change that began this Series.", 52),
        ("outlook-story-rise", "Primary Outlook Question: Your Rise", "Creation, Story, Outlook, Blessed",
         "Imagine that some people live without luxury. Through extraordinary coincidence or fortune, you received a life-changing windfall. What was it? Also ask why you pursued the Opportunity instead of spending the rest of your days in opulence.", 52),
        ("outlook-story-comfort", "Primary Outlook Question: Your Comfort", "Creation, Story, Outlook, Quiet",
         "Heroism is admirable, but small things keep us human. Choose a hobby or activity, unrelated to the adventure's main Change or Opportunity, in which you are deeply invested. Also ask whether going on the adventure helps you pursue it.", 53),
        ("outlook-story-weakness", "Primary Outlook Question: Your Weakness", "Creation, Story, Outlook, Confident",
         "If it is not true—if you are not the best—are you even yourself? Your life is full of people and achievements affirming your unmatched status, but once you faltered in that belief. Why? Also ask how many people know it happened and who they are.", 53),
        ...
        ("starting-attributes", "Starting Attributes", "Creation, Attributes",
         "Assign 4, 3, 2, and 2 among the Attributes. Body represents physical health and strength and affects Health and physical power. Talent covers speed and stunts and affects Speed and physical power. Spirit covers supernatural instinct and affects Focus and magic. Mind covers mundane knowledge and rational thought and affects utility actions. A high Primary Attribute is usually more effective than spreading increases thinly. Attribute growth and the Technique-Level conversion are handled by the builder.", 22),
        ...
        ("outlooks-boons", "Outlooks and Boons", "Creation, Outlooks, Boons",
         "Choose one Primary Outlook and two of its Boons. If that Outlook specifies an inherent Boon, take it in addition to those two. Boons apply only in unstructured play. As Tier increases, a hero may advance the Primary Outlook or branch into Secondary Outlooks, to a maximum of three total Outlooks: one Primary and up to two Secondary.", 23),
        ...
        ("technique-catalogue", "Reading The Technique Catalogue", "Creation, Techniques, Archetypes",
         "Every Technique has three Levels that must be taken in order. A hero may take Techniques from at most three Archetypes: the first is their Primary Archetype and the others are Secondary Archetypes. Complexity stars and tags describe intricacy and broad themes but have no mechanical effect. Flavor text is fiction and also has no mechanical effect. The six Archetypes are Powerhouse for sustained fights, Vagabond for defeating single targets, Bulwark for team defense, Altruist for helping allies, Disruptor for restriction and control, and Ruiner for high-impact, high-cost effects.", 66),
        ...
        ("story-birth", "Story Question: Birth", "Creation, Story, Prologue",
         "Where and in what condition was your character born? A loving, close-knit community suggests Light and more detail about Family. Becoming an outcast from a healthy community suggests Accursed and asking why. Abandonment at a young age suggests Wolf and may skip the Family question.", 25),
        ("story-family", "Story Question: Family", "Creation, Story, Prologue",
         "Who shaped your character in childhood? Privilege, royalty, or a secret clan suggests Deceive or Command and Blessed or Loyal; ask whether they still belong. Hard-working or business family suggests Endure or Connect and Apprentice or Light; ask how the family is now and why the character left. Systemic or fundamental disadvantage suggests Move or Absorb and Rebel or Quiet; ask what the family could provide.", 25),
        ("story-ambition", "Story Question: Ambition", "Creation, Story, Prologue",
         "Why did your character leave their family, and what does the family think? Being pushed toward a goal suggests Loyal and whether the character truly wants it. Leaving to pursue a dream suggests Confident and who supports it. Being forced from home suggests Wolf and asking what they know about why it happened.", 25),
        ("story-violence", "Story Question: Violence", "Creation, Story, Prologue",
         "How was the character trained to face violence, and when did they first face real danger? Circumstances that forced them to fight suggest Break or Menace and whether it made them stronger. Family training suggests Finesse or React and defining the tradition. An ambition that made them a better fighter suggests Luck or Tinker and asking how far they will go for the dream.", 25),
        ("story-ability", "Story Question: Ability", "Creation, Story, Prologue",
         "What is the character's Ability, if any, and how did they first encounter other Abilities? A useful Ability suggests Blessed or Confident and asking when it was discovered. An Ability seen as harmful suggests Quiet or Accursed and asking what made it seem negative. Having no Ability yet suggests Rebel or Apprentice and asking how the character feels about that.", 25),
        ("story-change", "Story Question: Change", "Creation, Story, The Adventure",
         "Discuss with at least the Narrator—and preferably the group—what suddenly changed in the world. Secret movements invite asking what the character knows compared with most people. A great success or failure by a nobody invites their opinion of that person. A sweeping change beyond mortal influence invites asking how it affected their personal life.", 26),
        ("story-settling-down", "Optional Story Step: Settling Down", "Creation, Story, The Adventure",
         "DAWN often begins during a character's rising action, but that is not required. If their personal journey has already peaked and entered a steady decline, record where they are now and let them follow the other characters as those characters rise.", 26),
        ("story-opportunity", "Story Question: Opportunity", "Creation, Story, The Adventure",
         "What recent opportunity to solve a practical problem or advance an ambition will bring the character to the other players? Coordinate with the Narrator if this opportunity appears in the first session. A natural event invites asking who else it affected; personal stakes invite asking how prepared the character is; joining an organization invites asking what they thought of it beforehand.", 26),
        ("example-qayid", "Example Hero: Qayid Āl-Rashid", "Creation, Example, Unstructured Play",
         "Tier 1 Rebel. Attributes: Body 4, Talent 3, Spirit 2, Mind 2. Skills: Break +2, Endure +1, React +1, one custom Skill +0. Boons: Until My Last Breath; Overexertion. Ability—Gravity Well [1]: You Can Enhance Gravity So Long As You Touch The Target; a direct tool for debilitating opponents.", 27),
        ("example-yvon", "Example Hero: Yvon Chevalier", "Creation, Example, Unstructured Play",
         "Tier 1 Quiet. Attributes: Body 2, Talent 4, Spirit 3, Mind 2. Skills: Lurk +2, Move +2, Intuit +1, Unveil +1. Boons: The Talent; Stalking Beast. Ability—Virtue: The Imaginary Number [1]: You Can Become Shadow; a cheap, mostly aesthetic Ability used for shadowy movement and stealth.", 27),
        ("example-titania", "Example Hero: Titania, The Prodigy", "Creation, Example, Unstructured Play",
         "Tier 1 Loyal. Attributes: Body 2, Talent 2, Spirit 3, Mind 4. Skills: Unveil +1, Tinker +1, Absorb +1, Luck +1. Boons: Fish Out Of Water; My Master's Teachings. Ability—Tonitru Companion [1]: You Can Launch Lightning If You See The Target; lightning stands in for electricity to keep the image magical.", 27),
        ("example-anseis", "Example Hero: Anseis Garrison", "Creation, Example, Unstructured Play",
         "Tier 1 Confident. Attributes: Body 2, Talent 3, Spirit 2, Mind 4. Skills: Deceive +2, Move +1, Luck +1, one custom Skill +0. Boons: Chatty; Perspective Of A Lancer. Ability—Virtue: Insatiable Venus [1]: You Can Attract People So Long As You Hear It; a long-reaching pull with a very loose restriction.", 27),
        ("recipe-magical-brawler", "Combat Recipe: Magical Brawler", "Creation, Recipe, Body",
         "Attributes: Body 4, Talent 2, Spirit 3, Mind 2. Start with SpellSword II. Choose an Elemental Affinity II: Flame Heart, Frost Veiler, Thunder Blood, or Wave Rider. Choose a Martial Art I: Martial Artist, Street Fighter, Technician, or Skirmisher. Tier-up paths: another Affinity; +2 Martial Art; +2 Rising Challenger; +2 Technician; or +1 SpellSword and +1 Berserker.", 28),
        ("recipe-scarred-warrior", "Combat Recipe: Scarred Warrior", "Creation, Recipe, Body",
         "Attributes: Body 4, Talent 3, Spirit 2, Mind 2. Choose a Fighting Style III: Dragonslayer, Street Fighter, Breacher, or Dual Wielder. Choose a Physical Build II: Speed Demon, Duelist, Vanguard Defender, Flagellant, or Mundane. Tier-up paths: +2 another Fighting Style; another Physical Build; +2 Skirmisher; +2 Feral Arcanist; or +2 Iron Bodied.", 28),
        ("recipe-tricksy-shinobi", "Combat Recipe: Tricksy Shinobi", "Creation, Recipe, Talent",
         "Attributes: Body 2, Talent 4, Spirit 2, Mind 3. Choose a Signature Technique III: Chemist, Mind Breaker, Surgeon, Enchained, or SwarmKin. Choose a Subtle Weapon II: Martial Artist, Knife Juggler, Gunslinger, Dual Wielder, or Bloodletter. Tier-up paths: +2 another Signature Technique; another Subtle Weapon; +2 Street Fighter; +2 Cutpurse; or +2 Spellcrafter.", 29),
        ("recipe-death-dealing-assassin", "Combat Recipe: Death-Dealing Assassin", "Creation, Recipe, Talent",
         "Attributes: Body 3, Talent 4, Spirit 2, Mind 2. Choose a Main Weapon III: Blade Master, Reaper, Sniper, Ranger (called Long Draw in this recipe), or Assassin. Choose a Method II: Intimidator, Untouchable, Cunning Fighter, Predator, or Analyst. Tier-up paths: +2 another Main Weapon; another Method; +2 Skirmisher; +2 Void Soul; or +2 Autophage.", 29),
        ("recipe-keen-caster", "Combat Recipe: Keen Caster", "Creation, Recipe, Spirit",
         "Attributes: Body 2, Talent 2, Spirit 4, Mind 3. Choose an Ability Type III: Flame Heart, Frost Veiler, Thunder Blood, Wave Rider, or Light Bender. Choose a Casting Type II: Spellcrafter, Bombardier, Eradicator, Ritualist, or Grim Ascendant. Tier-up paths: +2 another Ability Type; another Casting Type; +2 Dramaturge; +2 Zealot; or +2 Compassionate Sage.", 30),
        ("recipe-supportive-mage", "Combat Recipe: Supportive Mage", "Creation, Recipe, Spirit",
         "Attributes: Body 2, Talent 3, Spirit 4, Mind 2. Choose an Arcane Blessing III: Compassionate Sage, Temporal Sage, Replicator, Deckbuilder, or Abjuring Sage. Choose a Bent II: Talisman Exorcist, Eradicator, Analyst, or Empath. Tier-up paths: +2 another Arcane Blessing; another Bent; +2 Will-O-Wisp; +2 Guard Caller; or +2 Spellcrafter.", 30),
        ("recipe-battlefield-maven", "Combat Recipe: Battlefield Maven", "Creation, Recipe, Mind",
         "Attributes: Body 2, Talent 3, Spirit 2, Mind 4. Start with Cunning Fighter I. Choose Secret Knowledge II: Detective, Modified Meister, Battle Instructor, or Siren. Choose a Last Resort II: Martial Artist, Gunslinger, Dual Wielder, or Bloodletter. Tier-up paths: another Secret Knowledge; another Last Resort; +2 Skirmisher; +2 Cunning Fighter; or +2 Reflector.", 31),
        ("recipe-helpful-savant", "Combat Recipe: Helpful Savant", "Creation, Recipe, Mind",
         "Attributes: Body 2, Talent 2, Spirit 3, Mind 4. Choose a Special Interest III: Virtuoso, Fog Walker, Gourmand, Alchemist, or Will-O-Wisp. Choose a Personal Style II: Analyst, Dancer, Dramaturge, Empath, or Cutpurse. Tier-up paths: +2 another Special Interest; another Personal Style; +2 Skirmisher; +2 Iron Bodied; or +2 Tactical Master.", 31),
    ]
    return [{
...
def core_rules() -> dict:
    ...
    action_rows = [
        ...
        ("action.защита.наказание", "Defense", "Punish", "reaction", "focus", 2, "As a Reaction to a target leaving adjacency with you, you may Swiftly Skirmish that target at no Cost.", 64),
    ...
    npc_source = lambda page: {"editionId": NEW_ID, "locale": "en", "pdfPage": page}
    npc_rows = [
        {
            "id": "lionwing.npc.assassin", "role": "DPS", "name": "Assassin",
            "description": "Burst damage from stealth using Mark.", "examples": ["Imperial Assassins", "Wild Panthers", "Lurking Ghosts"],
            "statistics": {"health": "13 + [Tier × 5]", "speed": 3, "armor": 0, "evasion": 0},
            ...
            "actions": [
                {"id": "lionwing.npc.assassin.neutralize-target", "kind": "action", "name": "Neutralize Target", "text": "Target any character and Mark them. This NPC's Attacks do not remove Mark."},
                {"id": "lionwing.npc.assassin.slice", "kind": "attack", "name": "Slice", "text": "Roll 3 + [Tier] against an adjacent target. If Disappeared, this NPC may reappear adjacent to the target and gain 2 + [Tier] Advantage. Reward: Deal [Hits] + [Tension] damage; if the target has no adjacent characters, add [Tier] damage."},
            ],
            "ace": {"id": "lionwing.npc.assassin.hidden-blades", "tension": 2, "name": "Hidden Blades", "text": "For the rest of the Scene, whenever this NPC Disappears, leave a Hidden Blade in the space it left. It is Difficult Terrain that deals [Tier] damage to a character entering it, then removes itself."},
            "source": npc_source(114),
        },
        {
            "id": "lionwing.npc.bruiser", "role": "DPS", "name": "Bruiser",
            "description": "Attacks to Daze, then deals extra damage.", "examples": ["Professional Boxer", "Dire Gorilla", "Police Officer"],
            "statistics": {"health": "15 + [Tier × 5]", "speed": 3, "armor": "[Tier]", "evasion": 0},
            "passive": "If this NPC's Attack cannot push its target the full distance, the target is Dazed.",
            "actions": [
                {"id": "lionwing.npc.bruiser.beatdown", "kind": "action", "name": "Beatdown", "text": "Choose an adjacent Dazed target. Deal 2 damage to them 1 + [Tier] times."},
                {"id": "lionwing.npc.bruiser.skulduggery", "kind": "attack", "name": "Skulduggery", "text": "Choose all other targets in a 2 × 2 Zone placed on this NPC. Roll 4 + [Tier]. Reward: Deal [Hits] + [Tension] damage and push each target [Tier × 2] spaces."},
            ],
            "ace": {"id": "lionwing.npc.bruiser.decimate", "tension": 1, "name": "Decimate", "text": "Indicate a 3 × 3 Zone centered on a space 2 spaces away and become Steady. At the end of the next Turn, use Skulduggery against every opponent in that Zone with 2 + [Tier] Advantage."},
            "source": npc_source(114),
        },
        {
            "id": "lionwing.npc.behemoth", "role": "DPS", "name": "Behemoth",
            "description": "Endgame checkmate that creates Obstacles.", "examples": ["Terra Magi", "Gigantic Drake", "Wandering Undertaker"],
            "statistics": {"health": "13 + [Tier × 5]", "speed": 3, "armor": 0, "evasion": 0},
            "passive": "",
            "actions": [
                {"id": "lionwing.npc.behemoth.leap", "kind": "action", "name": "Leap", "text": "Disappear if this NPC has not Attacked this Turn. When it reappears, Launch and push every character within 2 spaces by 2 spaces unless they Dodge as if this were an Attack."},
                {"id": "lionwing.npc.behemoth.tore-from-earth", "kind": "attack", "name": "Tore From Earth", "text": "Choose up to 2 targets within 6 spaces. Roll 5 + [Tier]. Reward: Deal [Hits] + [Tension] damage and place a 15 + [Tier × 5] Health, 0 Armor Obstacle adjacent to them."},
            ],
            "ace": {"id": "lionwing.npc.behemoth.meteor", "tension": 5, "name": "Meteor", "text": "Teleport to the middle of the board and become Steady. At the start of the next Turn, Attack every character without an Obstacle between them and this NPC, instantly dealing 2 Wounds."},
            "source": npc_source(114),
        },
        {
            "id": "lionwing.npc.captor", "role": "DPS", "name": "Captor",
            "description": "Disrupts fragile targets at long range.", "examples": ["Retiarius", "Bounty Hunter", "Wolf-Hunting Spider"],
            "statistics": {"health": "13 + [Tier × 5]", "speed": 3, "armor": 0, "evasion": 0},
            "passive": "",
            "actions": [
                {"id": "lionwing.npc.captor.watch-and-wait", "kind": "action", "name": "Watch And Wait", "text": "Place unique Difficult Terrain in an unoccupied space within 4 spaces. When a character enters it, remove it and this NPC may use Catch And Release against them."},
                {"id": "lionwing.npc.captor.catch-and-release", "kind": "attack", "name": "Catch And Release", "text": "Choose a target within 4 spaces. Roll 5 + [Tier]. Reward: Deal [Hits] + [Tension] damage; Weaken and Snare the target if enemies have not Attacked them this Round."},
            ],
            "ace": {"id": "lionwing.npc.captor.sticky-bomb", "tension": 1, "name": "Sticky Bomb", "text": "Indicate an opponent within 5 spaces. At the end of the next Turn, use Catch And Release against every character within 3 spaces of them. Hit characters are pulled adjacent to and Snared by the indicated character instead of this NPC."},
            "source": npc_source(114),
        },
        {
            "id": "lionwing.npc.executioner", "role": "DPS", "name": "Executioner",
            "description": "Debilitating anti-tank attacks at a slow pace.", "examples": ["Axe Wielder", "Elderly Master", "Grim Reaper"],
            "statistics": {"health": "15 + [Tier × 5]", "speed": 3, "armor": 0, "evasion": 0},
            "passive": "This NPC is unaffected by Effects that lower its Speed or prevent movement.",
            "actions": [
                {"id": "lionwing.npc.executioner.focus", "kind": "action", "name": "Focus", "text": "Strengthen and Reinforce this NPC."},
                {"id": "lionwing.npc.executioner.cleave", "kind": "attack", "name": "Cleave", "text": "When this NPC Attacks without being Charged, it becomes Charged instead. While Charged, its Speed is 1 and it gains 1 + [Tier] Armor. Choose all targets in an adjacent 2-space Line. Roll 6 + [Tier × 2], then lose Charged. Reward: Deal [Hits] + [Tension × 2] damage; Shred a target if enemies have not Attacked them this Round."},
            ],
            "ace": {"id": "lionwing.npc.executioner.bifurcate", "tension": 2, "name": "Bifurcate", "text": "Indicate an opponent, become Charged, and become Steady. At the end of the next Turn, move adjacent to that opponent or as close as possible through as few spaces as possible, then use Cleave against opponents moved through or adjacent to."},
            "source": npc_source(115),
        },
        {
            "id": "lionwing.npc.javelin", "role": "DPS", "name": "Javelin",
            "description": "Creates and uses Fodder to make attacks.", "examples": ["Violent Fey", "Flame Summoner", "Automated Cannon"],
            "statistics": {"health": "15 + [Tier × 5]", "speed": 2, "armor": 0, "evasion": 0},
            "passive": "When this NPC Attacks, it may destroy a Fodder Zone in or adjacent to its space to extend its Attack range to 5 spaces.",
            "actions": [
                {"id": "lionwing.npc.javelin.call", "kind": "action", "name": "Call", "text": "Create 1 + [Tier] Fodder within 4 spaces. The amount created decreases by 1 each time this is used in the same Round."},
                {"id": "lionwing.npc.javelin.crushing-impact", "kind": "attack", "name": "Crushing Impact", "text": "Choose other targets in a 2 × 2 Zone placed on this NPC. Roll 4 + [Tier]. Reward: Deal [Hits] + [Tension] damage and Launch if there is only one target."},
            ],
            "ace": {"id": "lionwing.npc.javelin.shockwave", "tension": 1, "name": "Shockwave", "text": "Indicate a 5 × 5 Zone centered on this NPC and become Steady. At the end of the next Turn, use Crushing Impact against opposing targets in that Zone with [Tier] Advantage."},
            "source": npc_source(115),
        },
        {
            "id": "lionwing.npc.pugilist", "role": "DPS", "name": "Pugilist",
            "description": "All-rounder with rotating Effects on Attack.", "examples": ["Martial Artist", "Varied Arsenal", "4-Faced Demon"],
            "statistics": {"health": "15 + [Tier × 5]", "speed": 4, "armor": 0, "evasion": 0},
            "passive": "Each time this NPC Attacks, apply the next step, resetting after step 4: 1 — push the target 3 spaces, then follow; 2 — Snare the target; 3 — Launch the target; 4 — if the target is Launched, gain double Advantage from Spiking them.",
            "actions": [
                {"id": "lionwing.npc.pugilist.take-stance", "kind": "action", "name": "Take Stance", "text": "Set this NPC's Passive to any step, then Strengthen it."},
                {"id": "lionwing.npc.pugilist.flurry-of-strikes", "kind": "attack", "name": "Flurry Of Strikes", "text": "Roll 5 + [Tier] against an adjacent target. Reward: Deal [Hits] + [Tension] damage; Slow the target if enemies have not Attacked them this Round."},
            ],
            "ace": {"id": "lionwing.npc.pugilist.martial-perfection", "tension": 3, "name": "Martial Perfection", "text": "For the rest of combat, trigger this NPC's Passive twice on each Attack. This NPC immediately takes another Turn."},
            "source": npc_source(115),
        },
        {
            "id": "lionwing.npc.ranger", "role": "DPS", "name": "Ranger",
            "description": "Ultra-long-ranged attacker with high damage.", "examples": ["Careful Sniper", "Elven Archer", "Turret Emplacement"],
            "statistics": {"health": "13 + [Tier × 5]", "speed": 2, "armor": 0, "evasion": 0},
            "passive": "After this NPC is Attacked, it may move 1 space.",
            "actions": [
                {"id": "lionwing.npc.ranger.nest", "kind": "action", "name": "Nest", "text": "Become Steady and gain 1 Aim. Aim is lost when this NPC moves on its Turn and adds 1 damage to all of its successful Attacks."},
                {"id": "lionwing.npc.ranger.take-the-shot", "kind": "attack", "name": "Take The Shot", "text": "Choose a character within 8 spaces. Roll 5 + [Tier]. Deal [Tier + 2] additional damage if the target is at least 4 spaces away and enemies have not Attacked them this Round. Reward: Deal [Hits] + [Tension] damage."},
            ],
            "ace": {"id": "lionwing.npc.ranger.headshot", "tension": 2, "name": "Headshot", "text": "Choose any target. The next time this NPC's Attack hits them, they receive an additional [Hits] damage."},
            "source": npc_source(115),
        },
        {
            "id": "lionwing.npc.ronin", "role": "DPS", "name": "Ronin",
            "description": "Fast and versatile attacker with on-Crit Effects.", "examples": ["Wandering Duelist", "Crazed Killer", "Feral Hound"],
            "statistics": {"health": "13 + [Tier × 5]", "speed": 4, "armor": 0, "evasion": 0},
            "passive": "Start each Turn with 1 additional AP, but this NPC can target the same character only once each Turn.",
            "actions": [
                {"id": "lionwing.npc.ronin.sheath", "kind": "action", "name": "Sheath", "text": "The next time this NPC moves, it must spend 3 AP, but may also use Dissect against every character it moves into or out of adjacency with."},
                {"id": "lionwing.npc.ronin.dissect", "kind": "attack", "name": "Dissect", "text": "This Attack is Swift. Choose an adjacent target and roll 4 + [Tier]. Reward: Deal [Hits] + [Tension] damage. If at least 2 Crits were rolled, Shred and Slow the target."},
            ],
            "ace": {"id": "lionwing.npc.ronin.thunderclap-and-flash", "tension": 1, "name": "Thunderclap And Flash", "text": "Become Steady and indicate 4 Lines of any length connected end to end, with one connected to this NPC. At the end of the next Turn, move across every Line to the final end, ignoring characters and Terrain, then use Dissect against each opponent moved over or entered adjacency with. This Attack Crits on 5s."},
            "source": npc_source(116),
        },
        {
            "id": "lionwing.npc.viper", "role": "DPS", "name": "Viper",
            "description": "Spreads Blight and deals burst damage if not stopped.", "examples": ["Bandit", "Slinking Serpent", "Malevolent Spirit"],
            "statistics": {"health": "15 + [Tier × 5]", "speed": 4, "armor": 0, "evasion": 0},
            "passive": "After Attacking, move up to 3 spaces ignoring opponents. If this NPC passes through an opponent it has not Attacked this Turn, it may use Filet against them.",
            "actions": [
                {"id": "lionwing.npc.viper.lick-the-knife", "kind": "action", "name": "Lick The Knife", "text": "Deal damage to each Blighted player equal to the number of Blighted players + [Tier]."},
                {"id": "lionwing.npc.viper.filet", "kind": "attack", "name": "Filet", "text": "Choose an adjacent target, or do not activate the Passive to choose one within 5 spaces. Roll 4 + [Tier]. Reward: Deal [Hits] + [Tension] damage and Blight the target. If already Blighted, Mark them."},
            ],
            "ace": {"id": "lionwing.npc.viper.knife-in-the-dark", "tension": 2, "name": "Knife In The Dark", "text": "Disappear. At the end of the next Turn, use Filet to Teleport adjacent to and Attack every player without an adjacent ally, then reappear in any space."},
            "source": npc_source(116),
        },
        {
            "id": "lionwing.npc.witch", "role": "DPS", "name": "Witch",
            "description": "Area-of-effect ranged attacker with slow movement.", "examples": ["Dark Sorcerer", "Reckless Bomber", "Bile Spewer"],
            "statistics": {"health": "13 + [Tier × 5]", "speed": 2, "armor": 0, "evasion": 0},
            "passive": "After Attacking, indicate a 3 × 3 Zone centered on the space Attacked. At the end of the next Turn, every player in that Zone takes [Tier] damage.",
            "actions": [
                {"id": "lionwing.npc.witch.drawing-runes", "kind": "action", "name": "Drawing Runes", "text": "This Action costs 2 AP. Create a 3 × 3 Zone centered on this NPC, replacing any other such Zone. While this NPC is in it, every die it rolls counts as a Hit."},
                {"id": "lionwing.npc.witch.expelling-force", "kind": "attack", "name": "Expelling Force", "text": "Choose a target within 5 spaces. Roll 5 + [Tier]. Reward: Deal [Hits] + [Tension] damage and push the target 2 spaces away."},
            ],
            "ace": {"id": "lionwing.npc.witch.explosion", "tension": 1, "name": "EXPLOSION", "text": "Indicate a 4 × 4 Zone anywhere on the board and become Steady. At the end of the next Turn, this NPC may use Expelling Force against all opponents in the Zone with 1 + [Tier] Advantage, then remove the Zone."},
            "source": npc_source(116),
        },
        {
            "id": "lionwing.npc.bodyguards", "role": "Tank", "name": "Bodyguards",
            "description": "Enhanced Fodder that can buff allies.", "examples": ["Soldier Squad", "Churning Mass", "Wolf Pack"],
            "statistics": {"health": "1*", "speed": "0*", "armor": 0, "evasion": 0},
            "passive": "When this NPC would Deploy, Deploy 4 + [Tier] unique Fodder Zones instead. It cannot be Knocked Out until all of its Fodder Zones, or all non-Fodder characters, are Knocked Out; when either happens, this NPC takes 1 damage.",
            "actions": [
                {"id": "lionwing.npc.bodyguards.brace", "kind": "action", "name": "Brace", "text": "If at least 3 Fodder Zones are in a Line, they all become impassable until the Line is broken."},
                {"id": "lionwing.npc.bodyguards.behind-me", "kind": "attack", "name": "Behind Me", "text": "Move every Fodder Zone up to 1 space. Choose up to 3 characters adjacent to a Fodder Zone. Reinforce allied targets. Against opponents, roll 5 + [Tier]. Reward: Deal [Hits] + [Tension] damage and Daze targets enemies have not Attacked this Round."},
            ],
            "ace": {"id": "lionwing.npc.bodyguards.reinforcements", "tension": 2, "name": "Reinforcements", "text": "Create 3 + [Tier] Fodder Zones in spaces on the edge of the board. This NPC immediately takes another Turn."},
            "source": npc_source(117),
        },
        {
            "id": "lionwing.npc.broodmother", "role": "Tank", "name": "Broodmother",
            "description": "Creates Fodder when hit and Taunts.", "examples": ["Scarab Lord", "Transport Vehicle", "Tough Summoner"],
            "statistics": {"health": "15 + [Tier × 5]", "speed": 3, "armor": "[Tier]", "evasion": 0},
            "passive": "When this NPC takes damage while there are 5 + [Tier × 2] or fewer Fodder Zones on the board, it may place a Fodder Zone within 2 spaces." ,
            "actions": [
                {"id": "lionwing.npc.broodmother.call", "kind": "action", "name": "Call", "text": "Create 1 + [Tier] Fodder within 4 spaces. The amount created decreases by 1 each time this is used in the same Round."},
                {"id": "lionwing.npc.broodmother.swarming-chase", "kind": "attack", "name": "Swarming Chase", "text": "Move this NPC and all adjacent allies 1 space. Roll 4 + [Tier] against opponents this NPC moves adjacent to. Reward: Deal [Hits] + [Tension] damage, plus 1 for each Fodder Zone adjacent to the Broodmother."},
            ],
            "ace": {"id": "lionwing.npc.broodmother.roar", "tension": 2, "name": "Roar", "text": "Taunt all opponents in a 5 × 5 Zone centered on this NPC. It immediately takes another Turn."},
            "source": npc_source(117),
        },
        {
            "id": "lionwing.npc.cocoon", "role": "Tank", "name": "Cocoon",
            "description": "Endgame threat that absorbs Attacks early.", "examples": ["Slumbering Giant", "Patience", "Half-Built Machine"],
            "statistics": {"health": "18 + [Tier × 5]", "speed": 4, "armor": "[Tier]", "evasion": 0},
            "passive": "Start combat Scenes Docile. While Docile, this NPC cannot move or Attack and gains 1 Growth when it ends its Turn. On starting a Turn with at least 3 Growth, lose Docile and restore 10 + [Tier × 2] Health if any is missing.",
            "actions": [
                {"id": "lionwing.npc.cocoon.menace", "kind": "action", "name": "Menace", "text": "Fear all opponents within 3 spaces. If this NPC is Docile, an ally may move or Attack."},
                {"id": "lionwing.npc.cocoon.rampage", "kind": "attack", "name": "Rampage", "text": "Move up to 3 spaces in a straight Line, ignoring every form of restriction. Roll 4 + [Tier] against an adjacent target. Reward: Deal [Hits] + [Tension] damage and repeat this Attack, targeting only characters not Attacked this Turn."},
            ],
            "ace": {"id": "lionwing.npc.cocoon.quick-growth", "tension": 3, "name": "Quick Growth", "text": "Gain 1 Growth. This NPC immediately takes another Turn."},
            "source": npc_source(117),
        },
        {
            "id": "lionwing.npc.duelist", "role": "Tank", "name": "Duelist",
            "description": "Forces single targets to Attack this NPC in duels.", "examples": ["Royal Fencer", "Imperial Annoyance", "Latching Insect"],
            "statistics": {"health": "13 + [Tier × 5]", "speed": 4, "armor": 0, "evasion": 0},
            "passive": "Characters who Attack or are Attacked by this NPC are Taunted by it.",
            "actions": [
                {"id": "lionwing.npc.duelist.goad", "kind": "action", "name": "Goad", "text": "Taunt a character. If already Taunted by this NPC, force them to spend 2 Focus or move 3 spaces directly toward it, becoming Dazed if they move adjacent."},
                {"id": "lionwing.npc.duelist.fleche", "kind": "attack", "name": "Flèche", "text": "Choose a target within 2 spaces. Roll 5 + [Tier]. If the target is Taunted, deal [Tier] additional damage. Reward: Deal [Hits] + [Tension] damage and move 1 space."},
            ],
            "ace": {"id": "lionwing.npc.duelist.disassemble", "tension": 2, "name": "Disassemble", "text": "Place a weak point in an unoccupied space adjacent to a character; it follows its host's movement. When this NPC Attacks the host while standing in the weak point, deal [Tension] additional damage, consume the weak point, and this Ace may be used again immediately."},
            "source": npc_source(117),
        },
        {
            "id": "lionwing.npc.glutton", "role": "Tank", "name": "Glutton",
            "description": "Eats Fodder to heal and spits them out.", "examples": ["Ravenous Ogre", "Nanobot Swarm", "Splitting Slime"],
            "statistics": {"health": "20 + [Tier × 5]", "speed": 2, "armor": 0, "evasion": 0},
            "passive": "When this NPC Knocks Out a Fodder Zone, restore 3 + [Tier] Health and track how many times this healing triggers.",
            "actions": [
                {"id": "lionwing.npc.glutton.call", "kind": "action", "name": "Call", "text": "Create 1 + [Tier] Fodder within 4 spaces. The amount created decreases by 1 each time this is used in the same Round."},
                {"id": "lionwing.npc.glutton.slobber", "kind": "attack", "name": "Slobber", "text": "Choose up to 2 adjacent targets. Roll 5 + [Tier]. Reward: Deal [Hits] + [Tension] damage and Slow targets enemies have not Attacked this Round."},
            ],
            "ace": {"id": "lionwing.npc.glutton.regurgitate", "tension": 4, "name": "Regurgitate", "text": "Place as many Fodder Zones as this NPC destroyed with its Passive in spaces of your choice. Characters under placed Zones are Launched."},
            "source": npc_source(118),
        },
        {
            "id": "lionwing.npc.guardian", "role": "Tank", "name": "Guardian",
            "description": "Protects allies from a specific direction.", "examples": ["Honor-Bound Knight", "Big Body", "Stone Golem"],
            "statistics": {"health": "20 + [Tier × 5]", "speed": 3, "armor": "[Tier]", "evasion": 0},
            "passive": "Spaces adjacent to this NPC count as Difficult Terrain for its opponents.",
            "actions": [
                {"id": "lionwing.npc.guardian.guardian-shield", "kind": "action", "name": "Guardian Shield", "text": "Slow this NPC and place an adjacent 2 × 3 shield until the start of its next Turn; the Zone moves with it. Opponents Attacking in this area treat their targets as having 1 + [Tier] additional Armor."},
                {"id": "lionwing.npc.guardian.shove", "kind": "attack", "name": "Shove", "text": "Roll 4 + [Tier] against an adjacent target. Reward: Deal [Hits] + [Tension] damage, push the target 2 spaces away, and Launch them."},
            ],
            "ace": {"id": "lionwing.npc.guardian.imposing-presence", "tension": 3, "name": "Imposing Presence", "text": "For the rest of the Scene, characters adjacent to this NPC or within its shield are Taunted."},
            "source": npc_source(118),
        },
        {
            "id": "lionwing.npc.mount", "role": "Tank", "name": "Mount",
            "description": "Attaches to fragile allies to protect and enhance them.", "examples": ["Armored Horse", "Giant Salamander", "Dire Wolf"],
            "statistics": {"health": "15 + [Tier × 5]", "speed": 4, "armor": 0, "evasion": 0},
            ...
            "actions": [
                {"id": "lionwing.npc.mount.synergy", "kind": "action", "name": "Synergy", "text": "Use the rider's Action, or any 1-Cost Utility Action if the rider is a player."},
                {"id": "lionwing.npc.mount.thrash", "kind": "attack", "name": "Thrash", "text": "Choose up to 2 adjacent targets. Roll 5 + [Tier]. Reward: Deal [Hits] + [Tension] damage."},
            ],
            "ace": {"id": "lionwing.npc.mount.charge", "tension": 2, "name": "CHARGE!", "text": "Move up to this NPC's Speed in a straight Line. When the movement ends, its rider may use their Attack or Skirmish with [Tier] Advantage. This NPC immediately takes another Turn."},
            "source": npc_source(118),
        },
        {
            "id": "lionwing.npc.oni", "role": "Tank", "name": "Oni",
            "description": "Switches between healing and tanking stances.", "examples": ["Red & Blue Oni", "Stance Dancer", "Eclipse Magi"],
            "statistics": {"health": "15 + [Tier × 5]", "speed": 3, "armor": 0, "evasion": 0},
            ...
            "actions": [
                {"id": "lionwing.npc.oni.stabilize", "kind": "action", "name": "Stabilize", "text": "Lose this NPC's Effects and Hasten it."},
                {"id": "lionwing.npc.oni.polaris", "kind": "attack", "name": "Polaris", "text": "If Strengthened, move up to 2 spaces in a straight Line and target all characters entered adjacency with. If Reinforced, affect all allies in a centered 3 × 3 Zone except this NPC. Roll 5 + [Tier]; if both Effects apply, choose one mode. Reward: if Strengthened, deal [Hits] + [Tension] damage and Launch; if Reinforced, restore [Hits] Health and Hasten."},
            ],
            "ace": {"id": "lionwing.npc.oni.vibrant-terror", "tension": 4, "name": "Vibrant Terror", "text": "For the rest of the Scene, this NPC gains double the benefits from positive Effects. It immediately takes another Turn."},
            "source": npc_source(119),
        },
        {
            "id": "lionwing.npc.paladin", "role": "Tank", "name": "Paladin",
            "description": "Can both Daze enemies and heal allies.", "examples": ["Holy Warrior", "Reassuring Comrade", "Pack Guardian"],
            "statistics": {"health": "18 + [Tier × 5]", "speed": 3, "armor": "[Tier]", "evasion": 0},
            "passive": "When this NPC Attacks allies, it deals no damage and restores the same amount of Health instead.",
            "actions": [
                {"id": "lionwing.npc.paladin.gospel", "kind": "action", "name": "Gospel", "text": "Reinforce Regenerating allies."},
                {"id": "lionwing.npc.paladin.gift-from-god", "kind": "attack", "name": "Gift From God", "text": "Choose up to 2 adjacent targets. Roll 4 + [Tier]. Reward: Deal [Hits] + [Tension] damage and Daze an opposing target enemies have not Attacked this Round, or give an allied target Regenerating."},
            ],
            "ace": {"id": "lionwing.npc.paladin.weal-and-woe", "tension": 1, "name": "Weal And Woe", "text": "Use Gift From God against all characters within 2 spaces."},
            "source": npc_source(119),
        },
        {
            "id": "lionwing.npc.revenant", "role": "Tank", "name": "Revenant",
            "description": "Immortal NPC that drains Focus on Attack.", "examples": ["Chilling Spirit", "Reassembling Skeleton", "Grey Mage"],
            "statistics": {"health": "10 + [Tier × 5]", "speed": 3, "armor": 0, "evasion": 0},
            ...
            "actions": [
                {"id": "lionwing.npc.revenant.lurk", "kind": "action", "name": "Lurk", "text": "All opponents with at most 1 Focus are Feared by non-Revenant characters within 2 spaces."},
                {"id": "lionwing.npc.revenant.tear-from-the-soul", "kind": "attack", "name": "Tear From The Soul", "text": "Choose a target within 3 spaces. Roll 5 + [Tier]. Reward: Deal [Hits] + [Tension] damage and make the target lose 1 + [Tier] Focus."},
            ],
            "ace": {"id": "lionwing.npc.revenant.hollowed-eyes", "tension": 2, "name": "Hollowed Eyes", "text": "Indicate the player with the least Focus. At the end of the next Turn, use Tear From The Soul, Teleport adjacent to that player, and gain 6 + [Tier] Advantage minus the target's current Focus."},
            "source": npc_source(119),
        },
        {
            "id": "lionwing.npc.spright", "role": "Tank", "name": "Spright",
            "description": "Dodge tank that benefits from movement.", "examples": ["Old Sensei", "Excitable Newbie", "Thunder Fey"],
            "statistics": {"health": "13 + [Tier × 5]", "speed": 5, "armor": 0, "evasion": 0},
            "passive": "When this NPC ends movement, gain Evasion equal to the distance from its original position.",
            "actions": [
                {"id": "lionwing.npc.spright.discombobulate", "kind": "action", "name": "Discombobulate", "text": "Choose an adjacent target. If it has more Evasion than Armor, Slow it; if more Armor than Evasion, Shred it; if it has neither, Mark it."},
                {"id": "lionwing.npc.spright.incision", "kind": "attack", "name": "Incision", "text": "Roll 5 + [Tier] against an adjacent target. Reward: Deal [Hits] + [Tension] damage and Teleport to the space adjacent to the target that is farthest from the NPC's current space."},
            ],
            "ace": {"id": "lionwing.npc.spright.thunderous-ascension", "tension": 2, "name": "Thunderous Ascension", "text": "Increase this NPC's Speed by [Tier × 2]. For the rest of the Scene, once per Turn, when it moves into every space adjacent to an opponent, Slow and Daze that opponent. This NPC immediately takes another Turn."},
            "source": npc_source(119),
        },
        {
            "id": "lionwing.npc.bannerman", "role": "Support", "name": "Bannerman",
            "description": "Enhances and moves allies close to this NPC.", "examples": ["Battle Commander", "Psychic Lord", "Hivemind Minion"],
            "statistics": {"health": "18 + [Tier × 5]", "speed": 4, "armor": 0, "evasion": 0},
            "passive": "When this NPC moves, any ally in a centered 3 × 3 Zone may move adjacent to its new position.",
            "actions": [
                {"id": "lionwing.npc.bannerman.in-position", "kind": "action", "name": "In Position", "text": "Choose an ally within 6 spaces and a direction. Strengthen and Reinforce them, then move them 1 space in that direction, pushing obstructing characters. Repeat on adjacent allies, including this repeat, at most once per target."},
                {"id": "lionwing.npc.bannerman.swing", "kind": "attack", "name": "Swing", "text": "Roll 4 + [Tier] against an adjacent target. Reward: Deal [Hits] + [Tension] damage and Weaken the target if enemies have not Attacked them this Round."},
            ],
            "ace": {"id": "lionwing.npc.bannerman.plant-the-flag", "tension": 3, "name": "Plant The Flag", "text": "Place 15 + [Tier × 5] Health Terrain adjacent to this NPC. While it exists, use In Position at the start of each Round, and replace this NPC's Attack with another NPC's Attack from the board until the Terrain is destroyed."},
            "source": npc_source(120),
        },
        {
            "id": "lionwing.npc.builder", "role": "Support", "name": "Builder",
            "description": "Creates Terrain to disrupt enemies.", "examples": ["Stone Tosser", "Lava Fey", "Construction Worker"],
            "statistics": {"health": "15 + [Tier × 5]", "speed": 3, "armor": "[Tier]", "evasion": 0},
            "passive": "This NPC can move through Obstacles.",
            "actions": [
                {"id": "lionwing.npc.builder.landscape", "kind": "action", "name": "Landscape", "text": "Choose up to 3 unoccupied spaces within 4 spaces and make them High or Low Terrain."},
                {"id": "lionwing.npc.builder.violent-construction", "kind": "attack", "name": "Violent Construction", "text": "Choose a target within 6 spaces. Deal 2 + [Tier] damage and place a 15 + [Tier × 5] Health Obstacle adjacent to them."},
            ],
            "ace": {"id": "lionwing.npc.builder.army-of-stone", "tension": 2, "name": "Army Of Stone", "text": "Turn every piece of Terrain on the board into an allied Fodder Zone. This NPC immediately takes another Turn."},
            "source": npc_source(120),
        },
        {
            "id": "lionwing.npc.coordinator", "role": "Support", "name": "Coordinator",
            "description": "Has allies make extra Attacks on its Turn.", "examples": ["Squad Captain", "Inspiring Bard", "Pack Alpha"],
            "statistics": {"health": "13 + [Tier × 5]", "speed": 3, "armor": 0, "evasion": 0},
            "passive": "Allies within 4 spaces count as Strengthened during this NPC's Turn.",
            "actions": [
                {"id": "lionwing.npc.coordinator.neutralize-them", "kind": "action", "name": "Neutralize Them", "text": "Choose and Mark a target within 4 spaces."},
                {"id": "lionwing.npc.coordinator.fanaticize", "kind": "attack", "name": "Fanaticize", "text": "Move up to 1 space and roll 5 + [Tier] against an adjacent target. Reward: Deal [Hits] + [Tension] damage and have an ally move up to its Speed or use its primary Attack against a character not Attacked this Turn. A player ally may Cast or Skirmish."},
            ],
            "ace": {"id": "lionwing.npc.coordinator.coordinated-charge", "tension": 2, "name": "Coordinated Charge", "text": "Every other enemy within 5 spaces may move up to its Speed or use Fanaticize against a character not Attacked this Turn."},
            "source": npc_source(120),
        },
        {
            "id": "lionwing.npc.doppelganger", "role": "Support", "name": "Doppelgänger",
            "description": "Transforms into allies and duplicates itself.", "examples": ["Fey Trickster", "Mystic Chameleon", "Impersonator"],
            "statistics": {"health": "15 + [Tier × 5]", "speed": 5, "armor": 0, "evasion": 0},
            "passive": "If this NPC did not start its Turn Imitating another NPC, it may Attack twice during that Turn.",
            "actions": [
                {"id": "lionwing.npc.doppelganger.imitate", "kind": "action", "name": "Imitate", "text": "Imitate an allied NPC, replacing this NPC's non-Health statistics, Passive, Action, and Attack with the ally's. Imitation lasts until this NPC takes damage; it may then Teleport to a space within 6 spaces. It cannot Imitate the same NPC on consecutive Turns."},
            ],
            "ace": {"id": "lionwing.npc.doppelganger.diplopia", "tension": 3, "name": "Diplopia", "text": "Create 2 copies of this NPC in unoccupied adjacent spaces with the same Tier and current Health. This NPC immediately takes another Turn."},
            "source": npc_source(120),
        },
        {
            "id": "lionwing.npc.healer", "role": "Support", "name": "Healer",
            "description": "Chooses a favorite ally and heals them.", "examples": ["Imperial Cleric", "Battle Medic", "Partner Faerie"],
            "statistics": {"health": "13 + [Tier × 5]", "speed": 4, "armor": 0, "evasion": 0},
            "passive": "At the start of this NPC's Turn, it may choose an ally as its Guardian. While adjacent to its Guardian, this NPC does not count as a target if the Guardian is closer to an Attack when targets are chosen.",
            "actions": [
                {"id": "lionwing.npc.healer.heal", "kind": "action", "name": "Heal", "text": "Restore 2 + [Tier] Health to an ally within 3 spaces. Double this healing for this NPC's Guardian."},
                {"id": "lionwing.npc.healer.exsanguinate", "kind": "attack", "name": "Exsanguinate", "text": "Choose a target within 5 spaces. Roll 5 + [Tier]. Reward: Deal [Hits] + [Tension] damage and Mark the target. Whenever any Marked opponent is Attacked, the attacker restores 5 + [Tier] Health."},
            ],
            "ace": {"id": "lionwing.npc.healer.savior", "tension": 1, "name": "Savior", "text": "Remove all Effects from this NPC's Guardian; the Guardian begins Regenerating."},
            "source": npc_source(121),
        },
        {
            "id": "lionwing.npc.illusionist", "role": "Support", "name": "Illusionist",
            "description": "Swaps the positions of characters freely.", "examples": ["Mirror Magi", "Smoke Elemental", "Destabilizer"],
            "statistics": {"health": "15 + [Tier × 5]", "speed": 4, "armor": 0, "evasion": 0},
            "passive": "At the start of this NPC's Turn, it may swap the positions of any 2 NPCs. This counts as Teleporting for both." ,
            "actions": [
                {"id": "lionwing.npc.illusionist.spatial-rift", "kind": "action", "name": "Spatial Rift", "text": "Create 3 Walls with 10 + [Tier × 3] Health anywhere on the board."},
                {"id": "lionwing.npc.illusionist.distort-reality", "kind": "attack", "name": "Distort Reality", "text": "Choose any number of adjacent targets. Roll 4 + [Tier]. Reward: Deal [Hits] + [Tension] damage and put each target in Flux. When a character in Flux starts their Turn, this NPC may apply its Passive to them as if they were an NPC, removing Flux."},
            ],
            "ace": {"id": "lionwing.npc.illusionist.shattered-skies", "tension": 1, "name": "Shattered Skies", "text": "Immobilize this NPC. At the start of its next Turn, use Distort Reality against all opponents."},
            "source": npc_source(121),
        },
        {
            "id": "lionwing.npc.matriarch", "role": "Support", "name": "Matriarch",
            "description": "Creates safe spaces where allies are immune.", "examples": ["Shield Magi", "Mysterious Fey", "ER Responder"],
            "statistics": {"health": "15 + [Tier × 5]", "speed": 3, "armor": 0, "evasion": 0},
            "passive": "At the start of each Round, designate a space. For the rest of the Round, non-Matriarch enemies in that space are not targets unless a Matriarch is trying to target them.",
            "actions": [
                {"id": "lionwing.npc.matriarch.caress", "kind": "action", "name": "Caress", "text": "Choose any character and Teleport them to the designated space, or Teleport a character from the designated space elsewhere."},
                {"id": "lionwing.npc.matriarch.destroy-the-interloper", "kind": "attack", "name": "Destroy The Interloper", "text": "Choose a target in the designated space. Roll 5 + [Tier]. Reward: Deal [Hits] + [Tension] damage, Banish the target, and move them up to 4 spaces."},
            ],
            "ace": {"id": "lionwing.npc.matriarch.mother-of-the-void", "tension": 3, "name": "Mother Of The Void", "text": "For the rest of the Scene, this NPC may designate 2 spaces with its Passive. It immediately takes another Turn."},
            "source": npc_source(121),
        },
        {
            "id": "lionwing.npc.martyr", "role": "Support", "name": "Martyr",
            "description": "Takes damage to protect and heal allies.", "examples": ["Sacrifice", "Shield Generator", "Dedicated Leader"],
            "statistics": {"health": "13 + [Tier × 5]", "speed": 4, "armor": 0, "evasion": 0},
            "passive": "At the end of each Round, restore 5 + [Tier] Health to this NPC.",
            "actions": [
                {"id": "lionwing.npc.martyr.gorge-on-my-flesh", "kind": "action", "name": "Gorge On My Flesh", "text": "Deal 1 + [Tier] damage to this NPC. Until the end of its next Turn, all allies within 4 spaces gain 2 + [Tier] Armor."},
                {"id": "lionwing.npc.martyr.savor-my-blood", "kind": "attack", "name": "Savor My Blood", "text": "Choose a target within 5 spaces. Roll 5 + [Tier]. Reward: Deal [Hits] + [Tension] damage and restore Health to this NPC equal to half its missing Health."},
            ],
            "ace": {"id": "lionwing.npc.martyr.sacrifice", "tension": 3, "name": "Sacrifice", "text": "Knock Out this NPC and restore Health to all allies equal to twice each ally's Armor. Trigger this automatically if this NPC is Knocked Out while Tension is at least 4."},
            "source": npc_source(121),
        },
        {
            "id": "lionwing.npc.baron", "role": "Engine", "name": "Baron",
            "description": "Bans specific Attacks and punishes their users.", "examples": ["Imperial Justicar", "Law Faerie", "Syndicate Head"],
            "statistics": {"health": "15 + [Tier × 5]", "speed": 2, "armor": "[Tier]", "evasion": 0},
            ...
            "actions": [
                {"id": "lionwing.npc.baron.prescript", "kind": "action", "name": "Prescript", "text": "Choose up to 3 opponents. Each indicates a space; if they do not end their next Turn there, they receive a Wound."},
                {"id": "lionwing.npc.baron.suppress", "kind": "attack", "name": "Suppress", "text": "Roll 4 + [Tier] against an adjacent target. Reward: Deal [Hits] + [Tension] damage and Weaken the target if enemies have not Attacked them this Round."},
            ],
            "ace": {"id": "lionwing.npc.baron.absolute-sovereignty", "tension": 3, "name": "Absolute Sovereignty", "text": "For the rest of the Scene, name 2 Actions with the Passive, remove the restriction against repeating the same Action, and deal the Passive's damage once per named word."},
            "source": npc_source(122),
        },
        {
            "id": "lionwing.npc.berserker", "role": "Engine", "name": "Berserker",
            "description": "Gets into the fray and wants to take damage.", "examples": ["Outland Rager", "Aggressive Bouncer", "Wounded Rat"],
            "statistics": {"health": "18 + [Tier × 5]", "speed": 3, "armor": 0, "evasion": 0},
            ...
            "actions": [
                {"id": "lionwing.npc.berserker.seethe", "kind": "action", "name": "Seethe", "text": "Restore 2 + [Tier × 2] Health to this NPC."},
                {"id": "lionwing.npc.berserker.thrash", "kind": "attack", "name": "Thrash", "text": "Roll 5 + [Tier] against an adjacent target. Reward: Deal [Hits] + [Tension] damage and push the target 1 space away."},
            ],
            "ace": {"id": "lionwing.npc.berserker.last-stand", "tension": 3, "name": "Last Stand", "text": "Set this NPC's Health to 13 + [Tier × 5]. For the rest of the Scene, its Passive moves it 2 spaces. This NPC immediately takes another Turn."},
            "source": npc_source(122),
        },
        {
            "id": "lionwing.npc.cannoneer", "role": "Engine", "name": "Cannoneer",
            "description": "Slowly prepares a powerful ranged Attack.", "examples": ["Ship's Cannon", "Dragon's Maw", "Ritual Caster"],
            "statistics": {"health": "13 + [Tier × 5]", "speed": 1, "armor": 0, "evasion": 0},
            "passive": "When Deployed, begin tracking Preparation as a 4-Segment Clock that is emptied at the start of every Scene.",
            "actions": [
                {"id": "lionwing.npc.cannoneer.aim", "kind": "action", "name": "Aim", "text": "Strengthen this NPC and make it Steady."},
                {"id": "lionwing.npc.cannoneer.load", "kind": "attack", "name": "Load", "text": "Fill Preparation by 1 Segment, or 2 Segments if this NPC did not move this Turn."},
            ],
            "ace": {"id": "lionwing.npc.cannoneer.fire", "tension": 0, "name": "Fire", "text": "Use only when this NPC starts its Turn with full Preparation. Empty the Clock, choose a target within 10 spaces, and roll 5 + [Tier]. This Ace may be used more than once per Scene. Reward: Deal [Hits] + [Tension] damage 3 times."},
            "source": npc_source(122),
        },
        {
            "id": "lionwing.npc.cultist", "role": "Engine", "name": "Cultist",
            "description": "Raises Tension to summon stronger allies.", "examples": ["Spirit Caller", "Assembly Line", "Sentai Squad"],
            "statistics": {"health": "13 + [Tier × 5]", "speed": 2, "armor": 0, "evasion": 0},
            "passive": "Whenever this NPC increases Tension, add 1 Doom counter to the Scene. During players' Turns, they treat Tension as 1 lower per Doom counter.",
            "actions": [
                {"id": "lionwing.npc.cultist.ritual-drawings", "kind": "action", "name": "Ritual Drawings", "text": "Increase Tension by 1 and place Ritual tokens in 3 empty spaces. When an opponent enters one, remove it, deal [Tension] damage, and Daze them."},
                {"id": "lionwing.npc.cultist.swipe", "kind": "attack", "name": "Swipe", "text": "Roll 4 + [Tier] against an adjacent target. Reward: Deal [Hits] + [Tension] damage."},
            ],
            "ace": {"id": "lionwing.npc.cultist.grand-calling", "tension": 8, "name": "Grand Calling", "text": "Knock Out this NPC and create a non-Cultist NPC of a chosen type in its former space. Apply the Giant NPC Modifier to it and set its Tier to twice the Cultist's Tier."},
            "source": npc_source(123),
        },
        {
            "id": "lionwing.npc.daredevil", "role": "Engine", "name": "Daredevil",
            "description": "Moves and Attacks as Tension rises.", "examples": ["Local Hero", "Chaotic Imp", "Sparkling Performer"],
            "statistics": {"health": "15 + [Tier × 5]", "speed": 4, "armor": 0, "evasion": 0},
            "passive": "When Tension increases, move up to 3 spaces in a straight Line. If this ends adjacent to a character, deal 2 + [Tier] damage to that character, at most once per movement.",
            "actions": [
                {"id": "lionwing.npc.daredevil.gloat", "kind": "action", "name": "Gloat", "text": "Increase Tension by 1."},
                {"id": "lionwing.npc.daredevil.dance", "kind": "attack", "name": "Dance", "text": "Choose up to 2 adjacent targets. Roll 4 + [Tier]. Reward: Deal [Hits] + [Tension] damage and Launch the targets."},
            ],
            "ace": {"id": "lionwing.npc.daredevil.adrenaline-high", "tension": 4, "name": "Adrenaline High", "text": "For the rest of the Scene, this NPC's primary Attack deals [Tier] additional damage and its Passive movement may move up to 6 spaces. This NPC immediately takes another Turn."},
            "source": npc_source(123),
        },
        {
            "id": "lionwing.npc.enchanter", "role": "Engine", "name": "Enchanter",
            "description": "Disrupts with debuffs and controls Actions.", "examples": ["Luring Fey", "Puppet Master", "Neuro Toxician"],
            "statistics": {"health": "13 + [Tier × 5]", "speed": 3, "armor": 0, "evasion": 0},
            "passive": "",
            "actions": [
                {"id": "lionwing.npc.enchanter.charm", "kind": "action", "name": "Charm", "text": "Choose a target within 5 spaces. Fear or Taunt them, then move them 3 spaces."},
                {"id": "lionwing.npc.enchanter.heartbreaker", "kind": "attack", "name": "Heartbreaker", "text": "Choose a target within 5 spaces. Roll 5 + [Tier]. Reward: Deal [Hits] + [Tension] damage; if the target was Feared or Taunted, Weaken and Slow them."},
            ],
            "ace": {"id": "lionwing.npc.enchanter.by-my-command", "tension": 2, "name": "By My Command", "text": "Choose a Taunted or Feared character. They gain 2 AP and must take a Turn in which they Attack an ally, or receive 1 Wound."},
            "source": npc_source(123),
        },
        {
            "id": "lionwing.npc.hound-master", "role": "Engine", "name": "Hound Master",
            "description": "Creates seeking Fodder that explodes.", "examples": ["Dog Tamer", "Rocket Platform", "Mystic Ranger"],
            "statistics": {"health": "15 + [Tier × 5]", "speed": 2, "armor": 0, "evasion": 0},
            "passive": "Fodder Zones may move 3 spaces instead of 2 at the end of this NPC's Turn.",
            "actions": [
                {"id": "lionwing.npc.hound-master.fire-seeker", "kind": "action", "name": "Fire Seeker", "text": "Choose a target at least 4 spaces away and create a Seeker adjacent to this NPC. A Seeker is special Fodder; on moving adjacent to its target, it disappears and deals 6 + [Tier] damage to all adjacent opponents."},
                {"id": "lionwing.npc.hound-master.shove", "kind": "attack", "name": "Shove", "text": "Choose a target within 3 spaces. Roll 5 + [Tier]. Reward: Deal [Hits] + [Tension] damage and push the target 2 spaces away."},
            ],
            "ace": {"id": "lionwing.npc.hound-master.wild-hunt", "tension": 2, "name": "Wild Hunt", "text": "Create 3 Seekers targeting the same character."},
            "source": npc_source(123),
        },
        {
            "id": "lionwing.npc.necromancer", "role": "Engine", "name": "Necromancer",
            "description": "Revives dead allies and Fears enemies.", "examples": ["Lich", "Scrap Reassembler", "Recovering Cleric"],
            "statistics": {"health": "13 + [Tier × 5]", "speed": 2, "armor": 0, "evasion": 0},
            "passive": "Enemies Knocked Out while this NPC is Deployed leave a Corpse in the space where they were Knocked Out.",
            "actions": [
                {"id": "lionwing.npc.necromancer.call-the-dead", "kind": "action", "name": "Call The Dead", "text": "Create 1 + [Tier] Fodder within 4 spaces. They count as Corpses while active. Reduce the number created by 1 each time this Action is reused in the same Round."},
                {"id": "lionwing.npc.necromancer.terrifying-shot", "kind": "attack", "name": "Terrifying Shot", "text": "Choose a target within 5 spaces. Roll 4 + [Tier]. Reward: Deal [Hits] + [Tension × 2] damage and Fear the target."},
            ],
            "ace": {"id": "lionwing.npc.necromancer.the-danse-macabre", "tension": 2, "name": "The Danse Macabre", "text": "Revive 2 Corpses as Bruisers, Vipers, or Rangers with Tier equal to this NPC's Tier minus 1, minimum 1."},
            "source": npc_source(124),
        },
        {
            "id": "lionwing.npc.privateer", "role": "Engine", "name": "Privateer",
            "description": "Attacks when allies Attack nearby enemies.", "examples": ["Running Gunman", "Bird Of Prey", "Mini Turret"],
            "statistics": {"health": "13 + [Tier × 5]", "speed": 4, "armor": 0, "evasion": 0},
            "passive": "Once per Round, when an ally Attacks an opponent within this NPC's Attack range, deal [Tier + 2] damage to that opponent.",
            "actions": [
                {"id": "lionwing.npc.privateer.escort", "kind": "action", "name": "Escort", "text": "Hasten an ally. When that ally moves, this NPC may move the same number of spaces as long as it does not end farther away from them."},
                {"id": "lionwing.npc.privateer.spray-and-pray", "kind": "attack", "name": "Spray And Pray", "text": "Affect all targets in a 2-space Line adjacent to this NPC. Roll 4 + [Tier]. Reward: Deal [Hits] + [Tension × 2] damage."},
            ],
            "ace": {"id": "lionwing.npc.privateer.gear-change", "tension": 3, "name": "Gear Change", "text": "For the rest of the Scene, this NPC may move 1 space at the end of every character's Turn. This NPC immediately takes another Turn."},
            "source": npc_source(124),
        },
        {
            "id": "lionwing.npc.rifter", "role": "Engine", "name": "Rifter",
            "description": "Creates portals that anyone can use.", "examples": ["Spacial Magi", "Tunnelling Mole", "Explosive Jumper"],
            "statistics": {"health": "13 + [Tier × 5]", "speed": 2, "armor": 0, "evasion": 0},
            "passive": "When this NPC begins any movement, including involuntary movement, create a Rift in the space it left and its destination. Once per Turn, when another character moves onto a Rift, they may remove it and Teleport to another Rift.",
            "actions": [
                {"id": "lionwing.npc.rifter.wild-shifting", "kind": "action", "name": "Wild Shifting", "text": "Teleport to a space within 3 spaces 3 times."},
                {"id": "lionwing.npc.rifter.emerge", "kind": "attack", "name": "Emerge", "text": "Teleport to a space within 5 spaces and choose all adjacent characters as targets. Roll 5 + [Tier]. Reward: Deal [Hits] + [Tension] damage."},
            ],
            "ace": {"id": "lionwing.npc.rifter.implode", "tension": 3, "name": "Implode", "text": "Every Rift explodes, applying the damaging portion of this NPC's primary Attack to all characters adjacent to or within a Rift."},
            "source": npc_source(124),
        },
        {
            "id": "lionwing.npc.swarm", "role": "Engine", "name": "Swarm",
            "description": "Enhanced Fodder that creates more Fodder.", "examples": ["Insect Swarm", "Bandit Squad", "Vestigial Limbs"],
            "statistics": {"health": "1*", "speed": "0*", "armor": 0, "evasion": 0},
            "passive": "When this NPC would be Deployed, place 4 + [Tier] unique Fodder Zones instead. This NPC cannot be Knocked Out until all its Zones or all non-Fodder enemies are Knocked Out; when either happens, this NPC takes 1 damage.",
            "actions": [
                {"id": "lionwing.npc.swarm.call", "kind": "action", "name": "Call", "text": "Create 1 + [Tier] Fodder Zones in spaces on the edge of the board. Reduce the number created by 1 each time this Action is reused in the same Round."},
                {"id": "lionwing.npc.swarm.tear", "kind": "attack", "name": "Tear", "text": "Move every Fodder Zone up to 1 space. Choose up to 3 opponents adjacent to a Fodder Zone and roll 5 + [Tier]. Reward: Deal [Hits] + [Tension] damage and Daze one target."},
            ],
            "ace": {"id": "lionwing.npc.swarm.reinforcements", "tension": 2, "name": "Reinforcements", "text": "Create 4 + [Tier] Fodder Zones in spaces on the edge of the board. This NPC immediately takes another Turn."},
            "source": npc_source(124),
        },
    ]
    rule_rows = [
        ...
        ("lionwing.modifier.artillery", "Modifiers", "Artillery", "scene-modifier", "Scene Modifier; Deploy alongside the Scene. After Deployment, choose one shape: two infinite Lines with no adjacent spaces between them, a 3 × 3 Zone, a 2 × 5 Zone, or every edge space. Indicate that shape anywhere on the board. At each Round's end, deal [Tension] damage to all opponents in the indicated spaces, then indicate a new area of the chosen shape.", 126),
        ("lionwing.modifier.blaze", "Modifiers", "Blaze", "npc-modifier", "NPC Modifier; Attach instead of Deploying. Gives 2 Speed. When the Host rolls its primary Attack and scores at least [Tier / 2] Critical Hits, it Blazes. Choose one effect for this Modifier: Burn deals [Tier] additional damage and pushes the target 1 space; Freeze Slows the target, or Immobilizes it if already Slowed; Accelerate Hastens and Strengthens the Host; Toughen Reinforces and Strengthens the Host.", 126),
        ("lionwing.modifier.collateral", "Modifiers", "Collateral", "scene-modifier", "Scene Modifier; Deploy alongside the Scene. Place friendly NPCs equal to 1.5 times the number of player characters in empty spaces. Each has 5 + [Tier] Health and cannot take Turns. Create a Peril Clock with one Segment per player character; fill a Segment when one of these NPCs is Knocked Out, and the players lose the combat when it fills. Enemies may target one as a player only if it is not adjacent to a non-VIP player or player-owned Summon, and otherwise cannot harm it. A player may remove one safely by Interacting and passing a 1 + [Tier] Spirit challenge Roll.", 126),
        ("lionwing.modifier.contagion", "Modifiers", "Contagion", "npc-modifier", "NPC Modifier; Attach instead of Deploying. Gives 5 + [Tier × 5] Evasion. When Attached, indicate a player character. At each Round's end, deal [Tension] damage to all opponents within 3 spaces of that character, excluding the indicated character, then indicate a new player character.", 126),
        ("lionwing.modifier.earthquake", "Modifiers", "Earthquake", "npc-modifier", "NPC Modifier; Attach instead of Deploying. Gives 5 + [Tier × 5] Evasion. When Attached, indicate In or Out. At each Round's end, deal [Tension] damage to all opponents farther than 2 spaces from the Host if In is indicated, or within 2 spaces if Out is indicated, then switch to the other option.", 126),
        ("lionwing.modifier.gargantuan", "Modifiers", "Gargantuan", "npc-modifier", "NPC Modifier; Attach instead of Deploying. Gives [Tier] Armor and 5 + [Tier × 5] Evasion. All connected Parts have 0 Speed and cannot move. On Attachment, expand one edge of the board by one space to 7 × 8; this NPC occupies every added space. Its Host gains an Attack: target up to two 2 × 2 Zones anywhere, remove Terrain previously created by this Attack, destroy Terrain there, push all characters out, and place Terrain in those spaces. Targeting that Terrain targets this NPC instead, and this NPC and its Parts may draw range from it. Roll 4 + [Tier]. Reward: deal [Hits] + [Tension] damage to characters moved by the Attack.", 126),
        ("lionwing.modifier.giant", "Modifiers", "Giant", "npc-modifier", "NPC Modifier; Attach instead of Deploying. Gives [Tier] Armor and 1 Speed. The Host occupies a 2 × 2 area and gains an Attack: move up to 4 spaces in a straight Line, ignoring opponents. Push each opponent moved through into an unoccupied space adjacent to the Host's new location and Launch them.", 127),
        ("lionwing.modifier.haven", "Modifiers", "Haven", "scene-modifier", "Scene Modifier; Deploy alongside the Scene. On Deployment, indicate a 3 × 3 Zone. At each Round's end, deal [Tension] damage to all opponents outside the indicated Zone, then move the Zone anywhere on the board.", 127),
        ("lionwing.modifier.isolation", "Modifiers", "Isolation", "scene-modifier", "Scene Modifier; Deploy alongside the Scene. When Attached, indicate a player character. At each Round's end, deal 2 + [Tier] damage multiplied by the number of player characters to all players within 3 spaces of the indicated character, excluding that character; divide this damage by the number of players receiving it. Then indicate another player.", 127),
        ("lionwing.modifier.legion", "Modifiers", "Legion", "scene-modifier", "Scene Modifier; Deploy alongside the Scene. On Deployment, create a Legion Clock with Segments equal to the number of Deployed players plus [Tier]. Fill one Segment whenever a non-Fodder enemy is Knocked Out; when full, Knock Out all enemies and end combat. At each Round's start, return up to [Tension] Knocked-Out non-Compound enemies at half Health to board-edge spaces. If fewer can return, create edge Fodder Zones equal to the difference.", 127),
        ("lionwing.modifier.vip", "Modifiers", "VIP", "scene-modifier", "Scene Modifier; Deploy alongside the Scene. Place one friendly NPC with 15 + [Tier] Health in an empty space; it cannot take Turns. Once per Turn when an ally leaves its adjacency, they may move it to their new position. If it is Knocked Out, all players are Knocked Out. Enemies may target it as a player Summon only if it is not adjacent to a non-VIP player or player-owned Summon, and otherwise cannot harm it.", 127),
        ("lionwing.modifier.vortex", "Modifiers", "Vortex", "npc-modifier", "NPC Modifier; Attach instead of Deploying. Gives 1 + [Tier] Armor. At each Round's end after Attachment, create 5 Fodder Zones spread across the board edge or edges farthest from the Host. These Zones may move only closer to the Host. When one touches the Host, Knock it Out and give the Host 1 Armor for the rest of the Scene. When this effect has increased its Armor by 3, deal 20 + [Tier × 2] damage to all players.", 127),
        ("lionwing.narrator.custom-npcs.overview", "Creating Enemies", "Creating Enemies", "narrator-guidance", "Experienced Narrators may create NPC Types for combat niches missing from the standard profiles. Begin with a strong fictional concept, then realize it mechanically with these guidelines. Modifier enemies are excluded because they do not follow normal rules or expected play patterns.", 128),
        ("lionwing.narrator.custom-npcs.roles", "Creating Enemies", "Defining The Type", "narrator-guidance", "Choose the NPC's combat role first. DPS threatens players into attacking it or dying. Tank prevents DPS allies from being focused down. Support helps DPS and Tanks succeed without being a major threat alone. Engine disrupts players, often unconventionally, when ignored.", 128),
        ("lionwing.narrator.custom-npcs.threats", "Creating Enemies", "Deciding The Primary Threat", "narrator-guidance", "A DPS generally has a good-damage Attack that can hit more than one character and applies a negative Effect. A Tank has an Action that makes itself easier to hit and/or allies harder to hit. A Support has a Passive that makes it harder to kill and an Action that helps allies deal or avoid damage. An Engine has a Passive that grows stronger over time and/or an Attack that creates a threat players must answer with specific actions.", 128),
        ("lionwing.narrator.custom-npcs.averages", "Creating Enemies", "NPC Number Averages", "narrator-guidance", "Use these baselines, adjusting for strength and specialization. Base Health: DPS 14; Tank 18, or 12 when armored; Support 13; Engine 13. Speed: DPS 3 and often moves through other Actions; Tank 3; Support 4; Engine 2. Base Attack dice: DPS 4 and can normally deal [Tier] extra damage with setup; Tank 5; Support 3; Engine 4 and can also deal reactive additional damage.", 128),
        ("lionwing.narrator.custom-npcs.limits", "Creating Enemies", "NPC Design Limits", "narrator-guidance", "Conditional Advantage and damage bonuses should not exceed 2 + [Tier]. Reliable damage without a Roll should not exceed [Tier] per Turn per target. NPCs should not Attack more than once per Turn. Healing can be about 4 higher than comparable damage. Powerful negative Effects should work only on targets not yet Attacked that Round.", 128),
        ("lionwing.narrator.scenarios.overview", "Combat Scenarios", "Alternative Combat Objectives", "narrator-guidance", "Knocking Out every enemy before all player characters are Knocked Out is the standard combat objective, not a requirement. The Narrator may change victory conditions for the fiction or simply for fun; the following scenarios are reusable examples.", 129),
        ("lionwing.narrator.scenarios.legend", "Combat Scenarios", "Scenario Map Legend", "rule", "In scenario diagrams, blue spaces are the player Deployment Zone, red spaces are the NPC Deployment Zone, grey spaces are standard Obstacles, gold spaces are unique Terrain explained by the scenario, and white spaces are ordinary empty spaces.", 129),
        ("lionwing.narrator.scenarios.defense", "Combat Scenarios", "Defense", "scenario", "The players win by reaching 6 Tension without an NPC starting its Turn in the gold area. Adding at least one Legion is highly recommended so defeating every enemy cannot bypass the objective.", 129),
        ("lionwing.narrator.scenarios.assault", "Combat Scenarios", "Assault", "scenario", "The players win by reaching 6 Tension while no NPC occupies the gold area and at least one player occupies it. Adding at least one Legion is highly recommended so defeating every enemy cannot bypass the objective.", 129),
        ("lionwing.narrator.scenarios.secure", "Combat Scenarios", "Secure", "scenario", "The players must capture an object across the field. A player standing in the gold area may pick it up with Improvise. They win by starting their Turn while holding it in their Deployment Zone. A holder is Slowed. Adding at least one Legion is highly recommended so defeating every enemy cannot bypass the objective.", 130),
        ("lionwing.narrator.scenarios.destroy", "Combat Scenarios", "Destroy", "scenario", "The players win by destroying special Terrain in the gold space with 20 + [Tier × 10] Health. It cannot take more than 5 damage at once or take damage 3 or more times during the same Turn. Taunting and Snaring enemies can make bursting the target harder.", 130),
        ("lionwing.narrator.scenarios.collateral", "Combat Scenarios", "Collateral", "scenario", "Deploy a Collateral Modifier into any gold spaces, then proceed with combat normally. Multi-target and high-Speed enemies are especially threatening when players must protect several people or objects.", 130),
        ("lionwing.narrator.scenarios.vip", "Combat Scenarios", "VIP", "scenario", "Deploy a VIP Modifier into the gold space, then proceed with combat normally. High single-target-damage and high-Speed enemies are especially threatening when the players must keep one person or object safe.", 130),
        ...
        ("lionwing.narrator.deployments.hornets-nest", "Deployment Recipes", "Kicking The Hornet's Nest", "deployment-recipe", "Deploy 5 Tier [Average Tier] enemies split among Fighter Squads (Swarm), Guard Squads (Bodyguards), Zombies (Revenant), Deployers (Hound Master), and Litches (Necromancer). Deploy 4 Fodder Zones with them.", 113),
        ("lionwing.narrator.deployments.taking-on-a-god", "Deployment Recipes", "Taking On A God", "deployment-recipe", "Deploy one Compound enemy with 4 Parts. Each Part is Tier [Average Tier × 1.5], counts as an Antagonist, and is chosen from Strong Body (Bruiser), Ultimate Technique (Behemoth), Deadly Weapon (Executioner), Slow Start (Cocoon), Lighting Swiftness (Spright), Violent Temper (Berserker), or Accurate Sidearm (Cannoneer).", 113),
        ...
        ("lionwing.core.progression.tier", "Progression", "Increasing Tier", "rule", "Characters start at Tier 1 and can advance to Tier 6. On a Tier increase, add 1 to two different Attributes: raising Body adds 1 Health, raising Talent or Spirit to an odd value adds 1 Speed or starting Focus respectively, and raising Mind changes no derived statistic. Gain 2 Character Ranks; gain one Boon from the starting Outlook or branch into up to two other Outlooks; and gain 2 Technique Levels. Instead of Technique Levels, add 1 to the highest Attribute.", 32),
        ...
        ("lionwing.core.progression.pacing", "Progression", "Faster Or Slower Tiers", "optional-rule", "For faster advancement, raise base Experience per Chapter to 3 and grant 1 additional Experience for each Influence spent rather than each distinct use, to a maximum of 6 Experience per Chapter. The Narrator may instead advance the whole party whenever desired without tracking Experience, speeding up or slowing down the Series as needed.", 32),
        ...
        ("lionwing.core.general.materials", "Universal Rules", "Play Materials", "rule", "Playing DAWN requires this book or its rules reference, plenty of six-sided dice, character sheets, a group with players and a Narrator, and a 7 × 7 board. A 6 × 6 tile board may substitute if pieces stand on line intersections as in Go.", 35),
        ("lionwing.core.general.roles", "Universal Rules", "Playing The Game", "rule", "The Narrator organizes the game, respects player needs, prepares any included visuals or audio, and presents the world. Other players create and portray one character, interact with that world, and share the spotlight. A complete game for one group is a Series made from separate play sessions called Chapters.", 35),
        ...
        ("lionwing.core.general.specific-overrides", "Universal Rules", "Specific Overrides General", "rule", "When a specific rule contradicts a general rule, follow the specific rule. If two specific rules contradict each other, their user chooses which one to apply.", 35),
    ...
    return {
        ...
        "npcs": {"list": npc_rows},
        "rules": rules,
        "source": {"editionId": NEW_ID, "locale": "en", "pdfPages": list(range(22, 66)) + list(range(104, 131))},
    }
...
def builder_rules() -> dict:
    ...
    return {
        ...
        "progression": {"experienceToTier": 15, "chapterBaseExperience": 2, "chapterMaximumExperience": 4, "experiencePerUniqueInfluenceUse": 1, "rewardsMayBeSavedForAwakening": True, "optionalFast": {"chapterBaseExperience": 3, "chapterMaximumExperience": 6, "experiencePerInfluenceSpent": 1}, "partyTierAtNarratorPaceAllowed": True},
...
def write_canonical_corpus(overlay: dict) -> None:
    ...
    manifest = {
        ...
        "counts": {
            ...
            "coreNpcs": len(overlay["coreRules"].get("npcs", {}).get("list", [])),
