...
- **Текущий адаптер:** статус `full`; реестр: `scene-actions.js:108`, `scene-actions.js:122`.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:22`, `scene-actions.js:65`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `full`; реестр: `scene-actions.js:109`, `scene-actions.js:121`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:21`, `scene-actions.js:66`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:23`, `scene-actions.js:67`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** частичная конфигурация есть в `scene-actions.js:153`, но исполнимого статуса нет.
...
- **Текущий адаптер:** статус `full`; реестр: `scene-actions.js:110`, `scene-actions.js:123`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:25`, `scene-actions.js:69`, `scene-actions.js:777`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:26`, `scene-actions.js:70`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:27`, `scene-actions.js:71`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `state`; реестр: `scene-actions.js:128`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `full`; реестр: `scene-actions.js:111`, `scene-actions.js:135`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:28`, `scene-actions.js:72`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:29`, `scene-actions.js:73`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:30`, `scene-actions.js:74`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:31`, `scene-actions.js:75`, `scene-actions.js:154`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:38`, `scene-actions.js:76`, `scene-actions.js:155`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:32`, `scene-actions.js:77`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `effect`; реестр: `scene-actions.js:113`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Заявленный кодовый статус:** `attack` (атака).
- **Входная конфигурация:** `{"kind":"attack","apCost":1,"tension":0,"dice":"5(+1)","tensionMultiplier":2,"target":"targetIds: 1..1, adjacent"}`.
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:33`, `scene-actions.js:78`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `full`; реестр: `scene-actions.js:114`, `scene-actions.js:137`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:34`, `scene-actions.js:79`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:36`, `scene-actions.js:68`, `scene-actions.js:156`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:42`, `scene-actions.js:80`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Заявленный кодовый статус:** `state` (состояние).
- **Входная конфигурация:** `{"kind":"trump","apCost":2,"tension":3,"target":"targetIds: 0"}`.
- **Текущий адаптер:** статус `state`; реестр: `scene-actions.js:131`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:37`, `scene-actions.js:81`, `scene-actions.js:157`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `full`; реестр: `scene-actions.js:115`, `scene-actions.js:125`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:40`, `scene-actions.js:83`, `scene-actions.js:159`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:45`, `scene-actions.js:87`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** частичная конфигурация есть в `scene-actions.js:88`, но исполнимого статуса нет.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:49`, `scene-actions.js:89`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Заявленный кодовый статус:** `attack` (атака).
- **Входная конфигурация:** `{"kind":"attack","apCost":1,"tension":0,"dice":"5(+1)","tensionMultiplier":1,"target":"targetIds: 1..1"}`.
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:50`, `scene-actions.js:90`, `scene-actions.js:160`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:51`, `scene-actions.js:91`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:54`, `scene-actions.js:93`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `full`; реестр: `scene-actions.js:118`, `scene-actions.js:126`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** частичная конфигурация есть в `scene-actions.js:94`, `scene-actions.js:682`, `scene-actions.js:954`, но исполнимого статуса нет.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:41`, `scene-actions.js:84`, `scene-actions.js:161`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:55`, `scene-actions.js:95`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:56`, `scene-actions.js:96`, `scene-actions.js:162`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:57`, `scene-actions.js:97`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** частичная конфигурация есть в `scene-actions.js:98`, но исполнимого статуса нет.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:58`, `scene-actions.js:100`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:59`, `scene-actions.js:99`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
