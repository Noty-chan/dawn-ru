...
- **Текущий адаптер:** статус `full`; реестр: `scene-actions.js:111`, `scene-actions.js:126`.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:22`, `scene-actions.js:68`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `full`; реестр: `scene-actions.js:112`, `scene-actions.js:125`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:21`, `scene-actions.js:69`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:23`, `scene-actions.js:70`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** частичная конфигурация есть в `scene-actions.js:159`, но исполнимого статуса нет.
...
- **Текущий адаптер:** частичная конфигурация есть в `scene-actions.js:160`, но исполнимого статуса нет.
...
- **Текущий адаптер:** статус `full`; реестр: `scene-actions.js:113`, `scene-actions.js:127`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:25`, `scene-actions.js:72`, `scene-actions.js:796`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:26`, `scene-actions.js:73`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:27`, `scene-actions.js:74`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `full`; реестр: `scene-actions.js:114`, `scene-actions.js:139`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:28`, `scene-actions.js:75`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:29`, `scene-actions.js:76`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:30`, `scene-actions.js:77`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:31`, `scene-actions.js:78`, `scene-actions.js:161`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:38`, `scene-actions.js:79`, `scene-actions.js:162`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:32`, `scene-actions.js:80`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Заявленный кодовый статус:** `attack` (атака).
- **Входная конфигурация:** `{"kind":"attack","apCost":1,"tension":0,"dice":"5(+1)","tensionMultiplier":2,"target":"targetIds: 1..1, adjacent"}`.
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:33`, `scene-actions.js:81`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `full`; реестр: `scene-actions.js:117`, `scene-actions.js:141`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:34`, `scene-actions.js:82`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:36`, `scene-actions.js:71`, `scene-actions.js:163`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:42`, `scene-actions.js:83`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Заявленный кодовый статус:** `state` (состояние).
- **Входная конфигурация:** `{"kind":"trump","apCost":2,"tension":3,"target":"targetIds: 0"}`.
- **Текущий адаптер:** статус `state`; реестр: `scene-actions.js:135`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:37`, `scene-actions.js:84`, `scene-actions.js:164`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:39`, `scene-actions.js:85`, `scene-actions.js:165`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `full`; реестр: `scene-actions.js:118`, `scene-actions.js:129`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:40`, `scene-actions.js:86`, `scene-actions.js:166`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:54`, `scene-actions.js:95`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:45`, `scene-actions.js:90`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:46`, `scene-actions.js:91`.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:50`, `scene-actions.js:92`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Заявленный кодовый статус:** `attack` (атака).
- **Входная конфигурация:** `{"kind":"attack","apCost":1,"tension":0,"dice":"5(+1)","tensionMultiplier":1,"target":"targetIds: 1..1"}`.
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:51`, `scene-actions.js:93`, `scene-actions.js:167`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:52`, `scene-actions.js:94`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Заявленный кодовый статус:** `attack` (атака).
- **Входная конфигурация:** `{"kind":"attack","apCost":1,"tension":0,"dice":"6(+1)","tensionMultiplier":1,"target":"targetIds: 1..1, adjacent"}`.
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:43`, `scene-actions.js:88`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `full`; реестр: `scene-actions.js:122`, `scene-actions.js:130`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:60`, `scene-actions.js:97`, `scene-actions.js:689`, `scene-actions.js:981`.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:41`, `scene-actions.js:87`, `scene-actions.js:168`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:56`, `scene-actions.js:98`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Заявленный кодовый статус:** `attack` (атака).
- **Входная конфигурация:** `{"kind":"attack","apCost":1,"tension":0,"dice":"6(+1)","tensionMultiplier":1,"target":"targetIds: 1..1, range≤3"}`.
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:44`, `scene-actions.js:89`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:57`, `scene-actions.js:99`, `scene-actions.js:169`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:61`, `scene-actions.js:103`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
...
- **Текущий адаптер:** статус `attack`; реестр: `scene-actions.js:62`, `scene-actions.js:102`.
- **Нужно добавить / проверить:** Кодовый пробел не выведен из статуса; нужны прямые pos/neg/boundary тесты и evidence для UI/сети/save-load.
